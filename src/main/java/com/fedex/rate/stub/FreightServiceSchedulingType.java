...
public class FreightServiceSchedulingType implements java.io.Serializable {
    ...
    // Constructor
    protected FreightServiceSchedulingType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _LIMITED = "LIMITED";
    public static final String _STANDARD = "STANDARD";
    public static final String _WILL_CALL = "WILL_CALL";
    ...
    public static FreightServiceSchedulingType fromValue(String value)
    ...
    public static FreightServiceSchedulingType fromString(String value)
          throws IllegalArgumentException {
