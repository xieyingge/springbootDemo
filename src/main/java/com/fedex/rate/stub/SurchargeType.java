...
public class SurchargeType implements java.io.Serializable {
    ...
    public static final String _PEAK = "PEAK";
    public static final String _PEAK_ADDITIONAL_HANDLING = "PEAK_ADDITIONAL_HANDLING";
    public static final String _PEAK_OVERSIZE = "PEAK_OVERSIZE";
    public static final String _PEAK_RESIDENTIAL_DELIVERY = "PEAK_RESIDENTIAL_DELIVERY";
