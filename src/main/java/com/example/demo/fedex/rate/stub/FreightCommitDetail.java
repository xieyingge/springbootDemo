...
public class FreightCommitDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.FreightServiceCenterDetail originDetail;

    /* Information about the destination Freight Service Center. */
    private com.example.demo.fedex.rate.stub.FreightServiceCenterDetail destinationDetail;

    /* The distance between the origin and destination FreightService
     * Centers */
    private com.example.demo.fedex.rate.stub.Distance totalDistance;

    public FreightCommitDetail() {
    }

    public FreightCommitDetail(
           com.example.demo.fedex.rate.stub.FreightServiceCenterDetail originDetail,
           com.example.demo.fedex.rate.stub.FreightServiceCenterDetail destinationDetail,
           com.example.demo.fedex.rate.stub.Distance totalDistance) {
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightServiceCenterDetail getOriginDetail() {
        return originDetail;
    }
     ...
     */
    public void setOriginDetail(com.example.demo.fedex.rate.stub.FreightServiceCenterDetail originDetail) {
        this.originDetail = originDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightServiceCenterDetail getDestinationDetail() {
     ...
     */
    public void setDestinationDetail(com.example.demo.fedex.rate.stub.FreightServiceCenterDetail destinationDetail) {
        this.destinationDetail = destinationDetail;
    }
     ...
     * Centers
     */
    public com.example.demo.fedex.rate.stub.Distance getTotalDistance() {
     ...
     * Centers
     */
    public void setTotalDistance(com.example.demo.fedex.rate.stub.Distance totalDistance) {
        this.totalDistance = totalDistance;
    }
