...
public class RegulatoryLabelContentDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.RegulatoryLabelType type;

    /* Specifies how the customer requested the regulatory label to
     * be generated. */
    private com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType[] generationOptions;

    public RegulatoryLabelContentDetail() {
    }

    public RegulatoryLabelContentDetail(
           com.example.demo.fedex.rate.stub.RegulatoryLabelType type,
           com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType[] generationOptions) {
           this.type = type;
     ...
     * @return type
     */
    public com.example.demo.fedex.rate.stub.RegulatoryLabelType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.example.demo.fedex.rate.stub.RegulatoryLabelType type) {
        this.type = type;
    }
     ...
     * be generated.
     */
    public com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType[] getGenerationOptions() {
     ...
     * be generated.
     */
    public void setGenerationOptions(com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType[] generationOptions) {
        this.generationOptions = generationOptions;
    }

    public com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType getGenerationOptions(int i) {
        return this.generationOptions[i];
    }

    public void setGenerationOptions(int i, com.example.demo.fedex.rate.stub.CustomerSpecifiedLabelGenerationOptionType _value) {
