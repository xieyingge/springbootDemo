...
public class FreightBaseCharge  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.FreightClassType freightClass;

    /* Effective freight class used for rating this line item. */
    private com.example.demo.fedex.rate.stub.FreightClassType ratedAsClass;
    ...
    private com.example.demo.fedex.rate.stub.Money chargeRate;

    /* Identifies the manner in which the chargeRate for this line
     * item was applied. */
    private com.example.demo.fedex.rate.stub.FreightChargeBasisType chargeBasis;

    /* The net or extended charge for this line item. */
    private com.example.demo.fedex.rate.stub.Money extendedAmount;

    public FreightBaseCharge() {
    }

    public FreightBaseCharge(
           com.example.demo.fedex.rate.stub.FreightClassType freightClass,
           com.example.demo.fedex.rate.stub.FreightClassType ratedAsClass,
           String nmfcCode,
           String description,
           com.example.demo.fedex.rate.stub.Weight weight,
           com.example.demo.fedex.rate.stub.Money chargeRate,
           com.example.demo.fedex.rate.stub.FreightChargeBasisType chargeBasis,
           com.example.demo.fedex.rate.stub.Money extendedAmount) {
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightClassType getFreightClass() {
        return freightClass;
    }
     ...
     */
    public void setFreightClass(com.example.demo.fedex.rate.stub.FreightClassType freightClass) {
        this.freightClass = freightClass;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightClassType getRatedAsClass() {
        return ratedAsClass;
    }
     ...
     */
    public void setRatedAsClass(com.example.demo.fedex.rate.stub.FreightClassType ratedAsClass) {
        this.ratedAsClass = ratedAsClass;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getChargeRate() {
        return chargeRate;
    }
     ...
     */
    public void setChargeRate(com.example.demo.fedex.rate.stub.Money chargeRate) {
        this.chargeRate = chargeRate;
    }
     ...
     * item was applied.
     */
    public com.example.demo.fedex.rate.stub.FreightChargeBasisType getChargeBasis() {
        return chargeBasis;
    }
     ...
     * item was applied.
     */
    public void setChargeBasis(com.example.demo.fedex.rate.stub.FreightChargeBasisType chargeBasis) {
        this.chargeBasis = chargeBasis;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getExtendedAmount() {
     ...
     */
    public void setExtendedAmount(com.example.demo.fedex.rate.stub.Money extendedAmount) {
        this.extendedAmount = extendedAmount;
    }
