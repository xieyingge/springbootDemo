...
public class RecommendedDocumentSpecification  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.RecommendedDocumentType[] types;

    public RecommendedDocumentSpecification() {
    }

    public RecommendedDocumentSpecification(
           com.example.demo.fedex.rate.stub.RecommendedDocumentType[] types) {
           this.types = types;
    }
     ...
     * @return types
     */
    public com.example.demo.fedex.rate.stub.RecommendedDocumentType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(com.example.demo.fedex.rate.stub.RecommendedDocumentType[] types) {
        this.types = types;
    }

    public com.example.demo.fedex.rate.stub.RecommendedDocumentType getTypes(int i) {
        return this.types[i];
    }

    public void setTypes(int i, com.example.demo.fedex.rate.stub.RecommendedDocumentType _value) {
        this.types[i] = _value;
    }
