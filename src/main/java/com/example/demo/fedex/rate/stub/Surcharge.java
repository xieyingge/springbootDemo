...
public class Surcharge  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.SurchargeType surchargeType;

    private com.example.demo.fedex.rate.stub.SurchargeLevelType level;

    private String description;

    private com.example.demo.fedex.rate.stub.Money amount;

    public Surcharge() {
    }

    public Surcharge(
           com.example.demo.fedex.rate.stub.SurchargeType surchargeType,
           com.example.demo.fedex.rate.stub.SurchargeLevelType level,
           String description,
           com.example.demo.fedex.rate.stub.Money amount) {
     ...
     */
    public com.example.demo.fedex.rate.stub.SurchargeType getSurchargeType() {
        return surchargeType;
    }
     ...
     * @param surchargeType
     */
    public void setSurchargeType(com.example.demo.fedex.rate.stub.SurchargeType surchargeType) {
        this.surchargeType = surchargeType;
    }
     ...
     * @return level
     */
    public com.example.demo.fedex.rate.stub.SurchargeLevelType getLevel() {
        return level;
    }
     ...
     * @param level
     */
    public void setLevel(com.example.demo.fedex.rate.stub.SurchargeLevelType level) {
        this.level = level;
    }
     ...
     * @return amount
     */
    public com.example.demo.fedex.rate.stub.Money getAmount() {
        return amount;
    }
     ...
     * @param amount
     */
    public void setAmount(com.example.demo.fedex.rate.stub.Money amount) {
        this.amount = amount;
    }
