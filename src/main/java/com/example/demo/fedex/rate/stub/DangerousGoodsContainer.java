...
public class DangerousGoodsContainer  implements java.io.Serializable {
     ...
     * this container. */
    private com.example.demo.fedex.rate.stub.HazardousContainerPackingType packingType;
    ...
    private com.example.demo.fedex.rate.stub.RadioactiveContainerClassType radioactiveContainerClass;
    ...
    private com.example.demo.fedex.rate.stub.HazardousCommodityContent[] hazardousCommodities;

    public DangerousGoodsContainer() {
    }

    public DangerousGoodsContainer(
           com.example.demo.fedex.rate.stub.HazardousContainerPackingType packingType,
           String containerType,
           com.example.demo.fedex.rate.stub.RadioactiveContainerClassType radioactiveContainerClass,
           org.apache.axis.types.NonNegativeInteger numberOfContainers,
           com.example.demo.fedex.rate.stub.HazardousCommodityContent[] hazardousCommodities) {
     ...
     * this container.
     */
    public com.example.demo.fedex.rate.stub.HazardousContainerPackingType getPackingType() {
        return packingType;
    }
     ...
     * this container.
     */
    public void setPackingType(com.example.demo.fedex.rate.stub.HazardousContainerPackingType packingType) {
        this.packingType = packingType;
    }
     ...
     * the radioactive materials.
     */
    public com.example.demo.fedex.rate.stub.RadioactiveContainerClassType getRadioactiveContainerClass() {
     ...
     * the radioactive materials.
     */
    public void setRadioactiveContainerClass(com.example.demo.fedex.rate.stub.RadioactiveContainerClassType radioactiveContainerClass) {
        this.radioactiveContainerClass = radioactiveContainerClass;
    }
     ...
     * in the current container.
     */
    public com.example.demo.fedex.rate.stub.HazardousCommodityContent[] getHazardousCommodities() {
     ...
     * in the current container.
     */
    public void setHazardousCommodities(com.example.demo.fedex.rate.stub.HazardousCommodityContent[] hazardousCommodities) {
        this.hazardousCommodities = hazardousCommodities;
    }

    public com.example.demo.fedex.rate.stub.HazardousCommodityContent getHazardousCommodities(int i) {
        return this.hazardousCommodities[i];
    }

    public void setHazardousCommodities(int i, com.example.demo.fedex.rate.stub.HazardousCommodityContent _value) {
