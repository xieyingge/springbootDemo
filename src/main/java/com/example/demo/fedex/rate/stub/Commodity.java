...
public class Commodity  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.CommodityPurposeType purpose;
    ...
    private com.example.demo.fedex.rate.stub.Measure[] additionalMeasures;

    private com.example.demo.fedex.rate.stub.Money unitPrice;
     ...
     * duties and taxes */
    private com.example.demo.fedex.rate.stub.EdtExciseCondition[] exciseConditions;
     ...
     * Origin. */
    private com.example.demo.fedex.rate.stub.NaftaCommodityDetail naftaDetail;
    ...
    public Commodity(
           ...
           String description,
           com.example.demo.fedex.rate.stub.CommodityPurposeType purpose,
           String countryOfManufacture,
           String harmonizedCode,
           com.example.demo.fedex.rate.stub.Weight weight,
           java.math.BigDecimal quantity,
           String quantityUnits,
           com.example.demo.fedex.rate.stub.Measure[] additionalMeasures,
           com.example.demo.fedex.rate.stub.Money unitPrice,
           com.example.demo.fedex.rate.stub.Money customsValue,
           com.example.demo.fedex.rate.stub.EdtExciseCondition[] exciseConditions,
           String exportLicenseNumber,
           java.util.Date exportLicenseExpirationDate,
           String CIMarksAndNumbers,
           String partNumber,
           com.example.demo.fedex.rate.stub.NaftaCommodityDetail naftaDetail) {
           this.name = name;
     ...
     * @return purpose
     */
    public com.example.demo.fedex.rate.stub.CommodityPurposeType getPurpose() {
        return purpose;
    }
     ...
     * @param purpose
     */
    public void setPurpose(com.example.demo.fedex.rate.stub.CommodityPurposeType purpose) {
        this.purpose = purpose;
    }
     ...
     * weight and quantity to calculate duties and taxes.
     */
    public com.example.demo.fedex.rate.stub.Measure[] getAdditionalMeasures() {
     ...
     * weight and quantity to calculate duties and taxes.
     */
    public void setAdditionalMeasures(com.example.demo.fedex.rate.stub.Measure[] additionalMeasures) {
        this.additionalMeasures = additionalMeasures;
    }

    public com.example.demo.fedex.rate.stub.Measure getAdditionalMeasures(int i) {
        return this.additionalMeasures[i];
    }

    public void setAdditionalMeasures(int i, com.example.demo.fedex.rate.stub.Measure _value) {
     ...
     * @return unitPrice
     */
    public com.example.demo.fedex.rate.stub.Money getUnitPrice() {
        return unitPrice;
    }
     ...
     * @param unitPrice
     */
    public void setUnitPrice(com.example.demo.fedex.rate.stub.Money unitPrice) {
        this.unitPrice = unitPrice;
    }
     ...
     * duties and taxes
     */
    public com.example.demo.fedex.rate.stub.EdtExciseCondition[] getExciseConditions() {
     ...
     * duties and taxes
     */
    public void setExciseConditions(com.example.demo.fedex.rate.stub.EdtExciseCondition[] exciseConditions) {
        this.exciseConditions = exciseConditions;
    }

    public com.example.demo.fedex.rate.stub.EdtExciseCondition getExciseConditions(int i) {
        return this.exciseConditions[i];
    }

    public void setExciseConditions(int i, com.example.demo.fedex.rate.stub.EdtExciseCondition _value) {
     ...
     * Origin.
     */
    public com.example.demo.fedex.rate.stub.NaftaCommodityDetail getNaftaDetail() {
        return naftaDetail;
    }
     ...
     * Origin.
     */
    public void setNaftaDetail(com.example.demo.fedex.rate.stub.NaftaCommodityDetail naftaDetail) {
        this.naftaDetail = naftaDetail;
    }
