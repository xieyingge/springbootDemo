...
public class BatteryClassificationDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.BatteryMaterialType material;

    /* Describes the packing arrangement of the battery or cell with
     * respect to other items within the same package. */
    private com.example.demo.fedex.rate.stub.BatteryPackingType packing;

    /* A regulation specific classification for the battery or cell. */
    private com.example.demo.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType;

    public BatteryClassificationDetail() {
    }

    public BatteryClassificationDetail(
           com.example.demo.fedex.rate.stub.BatteryMaterialType material,
           com.example.demo.fedex.rate.stub.BatteryPackingType packing,
           com.example.demo.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType) {
     ...
     */
    public com.example.demo.fedex.rate.stub.BatteryMaterialType getMaterial() {
        return material;
    }
     ...
     */
    public void setMaterial(com.example.demo.fedex.rate.stub.BatteryMaterialType material) {
        this.material = material;
    }
     ...
     * respect to other items within the same package.
     */
    public com.example.demo.fedex.rate.stub.BatteryPackingType getPacking() {
        return packing;
    }
     ...
     * respect to other items within the same package.
     */
    public void setPacking(com.example.demo.fedex.rate.stub.BatteryPackingType packing) {
        this.packing = packing;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.BatteryRegulatorySubType getRegulatorySubType() {
     ...
     */
    public void setRegulatorySubType(com.example.demo.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType) {
        this.regulatorySubType = regulatorySubType;
    }
