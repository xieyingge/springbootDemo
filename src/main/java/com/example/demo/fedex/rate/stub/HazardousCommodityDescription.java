...
public class HazardousCommodityDescription  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.HazardousCommodityPackingGroupType packingGroup;

    private com.example.demo.fedex.rate.stub.HazardousCommodityPackingDetail packingDetails;
    ...
    private com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions;
    ...
    public HazardousCommodityDescription(
           ...
           com.example.demo.fedex.rate.stub.HazardousCommodityPackingGroupType packingGroup,
           com.example.demo.fedex.rate.stub.HazardousCommodityPackingDetail packingDetails,
           ...
           String labelText,
           com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions,
     ...
     * @return packingGroup
     */
    public com.example.demo.fedex.rate.stub.HazardousCommodityPackingGroupType getPackingGroup() {
        return packingGroup;
    }
     ...
     * @param packingGroup
     */
    public void setPackingGroup(com.example.demo.fedex.rate.stub.HazardousCommodityPackingGroupType packingGroup) {
        this.packingGroup = packingGroup;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.HazardousCommodityPackingDetail getPackingDetails() {
        return packingDetails;
    }
     ...
     */
    public void setPackingDetails(com.example.demo.fedex.rate.stub.HazardousCommodityPackingDetail packingDetails) {
        this.packingDetails = packingDetails;
    }
     ...
     * description of the dangerous goods commodity.
     */
    public com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType[] getProcessingOptions() {
     ...
     * description of the dangerous goods commodity.
     */
    public void setProcessingOptions(com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }

    public com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType getProcessingOptions(int i) {
        return this.processingOptions[i];
    }

    public void setProcessingOptions(int i, com.example.demo.fedex.rate.stub.HazardousCommodityDescriptionProcessingOptionType _value) {
