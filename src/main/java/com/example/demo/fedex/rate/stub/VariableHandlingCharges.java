...
public class VariableHandlingCharges  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.Money variableHandlingCharge;

    private com.example.demo.fedex.rate.stub.Money fixedVariableHandlingCharge;

    private com.example.demo.fedex.rate.stub.Money percentVariableHandlingCharge;

    private com.example.demo.fedex.rate.stub.Money totalCustomerCharge;

    public VariableHandlingCharges() {
    }

    public VariableHandlingCharges(
           com.example.demo.fedex.rate.stub.Money variableHandlingCharge,
           com.example.demo.fedex.rate.stub.Money fixedVariableHandlingCharge,
           com.example.demo.fedex.rate.stub.Money percentVariableHandlingCharge,
           com.example.demo.fedex.rate.stub.Money totalCustomerCharge) {
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getVariableHandlingCharge() {
        return variableHandlingCharge;
    }
     ...
     */
    public void setVariableHandlingCharge(com.example.demo.fedex.rate.stub.Money variableHandlingCharge) {
        this.variableHandlingCharge = variableHandlingCharge;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getFixedVariableHandlingCharge() {
        return fixedVariableHandlingCharge;
    }
     ...
     */
    public void setFixedVariableHandlingCharge(com.example.demo.fedex.rate.stub.Money fixedVariableHandlingCharge) {
        this.fixedVariableHandlingCharge = fixedVariableHandlingCharge;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getPercentVariableHandlingCharge() {
        return percentVariableHandlingCharge;
    }
     ...
     */
    public void setPercentVariableHandlingCharge(com.example.demo.fedex.rate.stub.Money percentVariableHandlingCharge) {
        this.percentVariableHandlingCharge = percentVariableHandlingCharge;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getTotalCustomerCharge() {
        return totalCustomerCharge;
    }
     ...
     */
    public void setTotalCustomerCharge(com.example.demo.fedex.rate.stub.Money totalCustomerCharge) {
        this.totalCustomerCharge = totalCustomerCharge;
    }
