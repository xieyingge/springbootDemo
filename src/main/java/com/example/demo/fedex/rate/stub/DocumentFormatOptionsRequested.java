...
public class DocumentFormatOptionsRequested  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.DocumentFormatOptionType[] options;

    public DocumentFormatOptionsRequested() {
    }

    public DocumentFormatOptionsRequested(
           com.example.demo.fedex.rate.stub.DocumentFormatOptionType[] options) {
     ...
     * @return options
     */
    public com.example.demo.fedex.rate.stub.DocumentFormatOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.example.demo.fedex.rate.stub.DocumentFormatOptionType[] options) {
        this.options = options;
    }

    public com.example.demo.fedex.rate.stub.DocumentFormatOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.example.demo.fedex.rate.stub.DocumentFormatOptionType _value) {
