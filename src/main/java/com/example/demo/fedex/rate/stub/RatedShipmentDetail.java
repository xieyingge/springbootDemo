...
public class RatedShipmentDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ShipmentRateDetail shipmentRateDetail;

    /* The package-level data for this rate type. */
    private com.example.demo.fedex.rate.stub.RatedPackageDetail[] ratedPackages;
    ...
    public RatedShipmentDetail(
           ...
           com.example.demo.fedex.rate.stub.ShipmentRateDetail shipmentRateDetail,
           com.example.demo.fedex.rate.stub.RatedPackageDetail[] ratedPackages) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentRateDetail getShipmentRateDetail() {
     ...
     */
    public void setShipmentRateDetail(com.example.demo.fedex.rate.stub.ShipmentRateDetail shipmentRateDetail) {
        this.shipmentRateDetail = shipmentRateDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.RatedPackageDetail[] getRatedPackages() {
     ...
     */
    public void setRatedPackages(com.example.demo.fedex.rate.stub.RatedPackageDetail[] ratedPackages) {
        this.ratedPackages = ratedPackages;
    }

    public com.example.demo.fedex.rate.stub.RatedPackageDetail getRatedPackages(int i) {
        return this.ratedPackages[i];
    }

    public void setRatedPackages(int i, com.example.demo.fedex.rate.stub.RatedPackageDetail _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getRatedPackages() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getRatedPackages(), i);
                if (obj != null &&
