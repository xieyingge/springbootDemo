...
public class Rebate  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.RebateType rebateType;
    ...
    public Rebate(
           com.example.demo.fedex.rate.stub.RebateType rebateType,
           String description,
     ...
     * @return rebateType
     */
    public com.example.demo.fedex.rate.stub.RebateType getRebateType() {
        return rebateType;
    }
     ...
     * @param rebateType
     */
    public void setRebateType(com.example.demo.fedex.rate.stub.RebateType rebateType) {
        this.rebateType = rebateType;
    }
