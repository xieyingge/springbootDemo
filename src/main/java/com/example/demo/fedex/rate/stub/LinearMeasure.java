...
public class LinearMeasure  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.LinearUnits units;
    ...
    public LinearMeasure(
           ...
           com.example.demo.fedex.rate.stub.LinearUnits units) {
           this.value = value;
           this.units = units;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.LinearUnits getUnits() {
        return units;
    }
     ...
     */
    public void setUnits(com.example.demo.fedex.rate.stub.LinearUnits units) {
        this.units = units;
    }
