...
public class RatedPackageDetail  implements java.io.Serializable {
     ...
     * provided). */
    private com.example.demo.fedex.rate.stub.TrackingId[] trackingIds;
    ...
    private com.example.demo.fedex.rate.stub.Money effectiveNetDiscount;

    /* Ground COD is shipment level. */
    private com.example.demo.fedex.rate.stub.Money adjustedCodCollectionAmount;

    private com.example.demo.fedex.rate.stub.OversizeClassType oversizeClass;

    /* Rate data that are tied to a specific package and rate type
     * combination. */
    private com.example.demo.fedex.rate.stub.PackageRateDetail packageRateDetail;

    public RatedPackageDetail() {
    }

    public RatedPackageDetail(
           com.example.demo.fedex.rate.stub.TrackingId[] trackingIds,
           org.apache.axis.types.NonNegativeInteger groupNumber,
           com.example.demo.fedex.rate.stub.Money effectiveNetDiscount,
           com.example.demo.fedex.rate.stub.Money adjustedCodCollectionAmount,
           com.example.demo.fedex.rate.stub.OversizeClassType oversizeClass,
           com.example.demo.fedex.rate.stub.PackageRateDetail packageRateDetail) {
     ...
     * provided).
     */
    public com.example.demo.fedex.rate.stub.TrackingId[] getTrackingIds() {
        return trackingIds;
    }
     ...
     * provided).
     */
    public void setTrackingIds(com.example.demo.fedex.rate.stub.TrackingId[] trackingIds) {
        this.trackingIds = trackingIds;
    }

    public com.example.demo.fedex.rate.stub.TrackingId getTrackingIds(int i) {
        return this.trackingIds[i];
    }

    public void setTrackingIds(int i, com.example.demo.fedex.rate.stub.TrackingId _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getEffectiveNetDiscount() {
     ...
     */
    public void setEffectiveNetDiscount(com.example.demo.fedex.rate.stub.Money effectiveNetDiscount) {
        this.effectiveNetDiscount = effectiveNetDiscount;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getAdjustedCodCollectionAmount() {
     ...
     */
    public void setAdjustedCodCollectionAmount(com.example.demo.fedex.rate.stub.Money adjustedCodCollectionAmount) {
        this.adjustedCodCollectionAmount = adjustedCodCollectionAmount;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.OversizeClassType getOversizeClass() {
        return oversizeClass;
    }
     ...
     * @param oversizeClass
     */
    public void setOversizeClass(com.example.demo.fedex.rate.stub.OversizeClassType oversizeClass) {
        this.oversizeClass = oversizeClass;
    }
     ...
     * combination.
     */
    public com.example.demo.fedex.rate.stub.PackageRateDetail getPackageRateDetail() {
     ...
     * combination.
     */
    public void setPackageRateDetail(com.example.demo.fedex.rate.stub.PackageRateDetail packageRateDetail) {
        this.packageRateDetail = packageRateDetail;
    }
