...
public class LiabilityCoverageDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.LiabilityCoverageType coverageType;

    /* Identifies the Liability Coverage Amount. For Jan 2010 this
     * value represents coverage amount per pound */
    private com.example.demo.fedex.rate.stub.Money coverageAmount;

    public LiabilityCoverageDetail() {
    }

    public LiabilityCoverageDetail(
           com.example.demo.fedex.rate.stub.LiabilityCoverageType coverageType,
           com.example.demo.fedex.rate.stub.Money coverageAmount) {
     ...
     * @return coverageType
     */
    public com.example.demo.fedex.rate.stub.LiabilityCoverageType getCoverageType() {
        return coverageType;
    }
     ...
     * @param coverageType
     */
    public void setCoverageType(com.example.demo.fedex.rate.stub.LiabilityCoverageType coverageType) {
        this.coverageType = coverageType;
    }
     ...
     * value represents coverage amount per pound
     */
    public com.example.demo.fedex.rate.stub.Money getCoverageAmount() {
     ...
     * value represents coverage amount per pound
     */
    public void setCoverageAmount(com.example.demo.fedex.rate.stub.Money coverageAmount) {
        this.coverageAmount = coverageAmount;
    }
