...
public class RateDiscount  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.RateDiscountType rateDiscountType;
    ...
    public RateDiscount(
           com.example.demo.fedex.rate.stub.RateDiscountType rateDiscountType,
           String description,
     ...
     */
    public com.example.demo.fedex.rate.stub.RateDiscountType getRateDiscountType() {
        return rateDiscountType;
    }
     ...
     */
    public void setRateDiscountType(com.example.demo.fedex.rate.stub.RateDiscountType rateDiscountType) {
        this.rateDiscountType = rateDiscountType;
    }
