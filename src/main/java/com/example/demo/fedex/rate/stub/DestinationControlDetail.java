...
public class DestinationControlDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.DestinationControlStatementType[] statementTypes;
    ...
    public DestinationControlDetail(
           com.example.demo.fedex.rate.stub.DestinationControlStatementType[] statementTypes,
     ...
     */
    public com.example.demo.fedex.rate.stub.DestinationControlStatementType[] getStatementTypes() {
        return statementTypes;
    }
     ...
     */
    public void setStatementTypes(com.example.demo.fedex.rate.stub.DestinationControlStatementType[] statementTypes) {
        this.statementTypes = statementTypes;
    }

    public com.example.demo.fedex.rate.stub.DestinationControlStatementType getStatementTypes(int i) {
        return this.statementTypes[i];
    }

    public void setStatementTypes(int i, com.example.demo.fedex.rate.stub.DestinationControlStatementType _value) {
