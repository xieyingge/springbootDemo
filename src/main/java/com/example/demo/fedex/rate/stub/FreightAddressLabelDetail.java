...
public class FreightAddressLabelDetail  implements java.io.Serializable {
     ...
     * will start. */
    private com.example.demo.fedex.rate.stub.PageQuadrantType startingPosition;
    ...
    public FreightAddressLabelDetail(
           ...
           com.example.demo.fedex.rate.stub.PageQuadrantType startingPosition,
     ...
     * will start.
     */
    public com.example.demo.fedex.rate.stub.PageQuadrantType getStartingPosition() {
     ...
     * will start.
     */
    public void setStartingPosition(com.example.demo.fedex.rate.stub.PageQuadrantType startingPosition) {
        this.startingPosition = startingPosition;
    }
