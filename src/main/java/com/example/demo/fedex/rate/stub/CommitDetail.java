...
public class CommitDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ServiceDescription serviceDescription;
     ...
     * to the caller. */
    private com.example.demo.fedex.rate.stub.ServiceOptionType[] appliedOptions;

    /* Supporting detail for applied options identified in preceding
     * field. */
    private com.example.demo.fedex.rate.stub.ServiceSubOptionDetail appliedSubOptions;

    private com.example.demo.fedex.rate.stub.SignatureOptionDetail derivedShipmentSignatureOption;

    private com.example.demo.fedex.rate.stub.SignatureOptionDetail[] derivedPackageSignatureOptions;

    private com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedOriginDetail;

    private com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedDestinationDetail;
    ...
    private com.example.demo.fedex.rate.stub.DayOfWeekType dayOfWeek;

    /* The number of transit days; applies to Ground and LTL Freight;
     * indicates minimum transit time for SmartPost. */
    private com.example.demo.fedex.rate.stub.TransitTimeType transitTime;

    /* Maximum number of transit days, for SmartPost shipments. */
    private com.example.demo.fedex.rate.stub.TransitTimeType maximumTransitTime;
    ...
    private com.example.demo.fedex.rate.stub.Address brokerAddress;
     ...
     * at the border. */
    private com.example.demo.fedex.rate.stub.DayOfWeekType brokerCommitDayOfWeek;
    ...
    private com.example.demo.fedex.rate.stub.DayOfWeekType proofOfDeliveryDayOfWeek;
    ...
    private com.example.demo.fedex.rate.stub.Notification[] commitMessages;
    ...
    private com.example.demo.fedex.rate.stub.DelayDetail[] delayDetails;

    private com.example.demo.fedex.rate.stub.InternationalDocumentContentType documentContent;

    /* Required documentation for this shipment. */
    private com.example.demo.fedex.rate.stub.RequiredShippingDocumentType[] requiredDocuments;

    /* Freight origin and destination city center information and
     * total distance between origin and destination city centers. */
    private com.example.demo.fedex.rate.stub.FreightCommitDetail freightCommitDetail;
    ...
    public CommitDetail(
           ...
           String serviceType,
           com.example.demo.fedex.rate.stub.ServiceDescription serviceDescription,
           com.example.demo.fedex.rate.stub.ServiceOptionType[] appliedOptions,
           com.example.demo.fedex.rate.stub.ServiceSubOptionDetail appliedSubOptions,
           com.example.demo.fedex.rate.stub.SignatureOptionDetail derivedShipmentSignatureOption,
           com.example.demo.fedex.rate.stub.SignatureOptionDetail[] derivedPackageSignatureOptions,
           com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedOriginDetail,
           com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedDestinationDetail,
           java.util.Calendar commitTimestamp,
           com.example.demo.fedex.rate.stub.DayOfWeekType dayOfWeek,
           com.example.demo.fedex.rate.stub.TransitTimeType transitTime,
           com.example.demo.fedex.rate.stub.TransitTimeType maximumTransitTime,
           String destinationServiceArea,
           com.example.demo.fedex.rate.stub.Address brokerAddress,
           String brokerLocationId,
           java.util.Calendar brokerCommitTimestamp,
           com.example.demo.fedex.rate.stub.DayOfWeekType brokerCommitDayOfWeek,
           org.apache.axis.types.NonNegativeInteger brokerToDestinationDays,
           java.util.Date proofOfDeliveryDate,
           com.example.demo.fedex.rate.stub.DayOfWeekType proofOfDeliveryDayOfWeek,
           com.example.demo.fedex.rate.stub.Notification[] commitMessages,
           String[] deliveryMessages,
           com.example.demo.fedex.rate.stub.DelayDetail[] delayDetails,
           com.example.demo.fedex.rate.stub.InternationalDocumentContentType documentContent,
           com.example.demo.fedex.rate.stub.RequiredShippingDocumentType[] requiredDocuments,
           com.example.demo.fedex.rate.stub.FreightCommitDetail freightCommitDetail) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ServiceDescription getServiceDescription() {
     ...
     */
    public void setServiceDescription(com.example.demo.fedex.rate.stub.ServiceDescription serviceDescription) {
        this.serviceDescription = serviceDescription;
    }
     ...
     * to the caller.
     */
    public com.example.demo.fedex.rate.stub.ServiceOptionType[] getAppliedOptions() {
     ...
     * to the caller.
     */
    public void setAppliedOptions(com.example.demo.fedex.rate.stub.ServiceOptionType[] appliedOptions) {
        this.appliedOptions = appliedOptions;
    }

    public com.example.demo.fedex.rate.stub.ServiceOptionType getAppliedOptions(int i) {
        return this.appliedOptions[i];
    }

    public void setAppliedOptions(int i, com.example.demo.fedex.rate.stub.ServiceOptionType _value) {
     ...
     * field.
     */
    public com.example.demo.fedex.rate.stub.ServiceSubOptionDetail getAppliedSubOptions() {
     ...
     * field.
     */
    public void setAppliedSubOptions(com.example.demo.fedex.rate.stub.ServiceSubOptionDetail appliedSubOptions) {
        this.appliedSubOptions = appliedSubOptions;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.SignatureOptionDetail getDerivedShipmentSignatureOption() {
        return derivedShipmentSignatureOption;
    }
     ...
     */
    public void setDerivedShipmentSignatureOption(com.example.demo.fedex.rate.stub.SignatureOptionDetail derivedShipmentSignatureOption) {
        this.derivedShipmentSignatureOption = derivedShipmentSignatureOption;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.SignatureOptionDetail[] getDerivedPackageSignatureOptions() {
        return derivedPackageSignatureOptions;
    }
     ...
     */
    public void setDerivedPackageSignatureOptions(com.example.demo.fedex.rate.stub.SignatureOptionDetail[] derivedPackageSignatureOptions) {
        this.derivedPackageSignatureOptions = derivedPackageSignatureOptions;
    }

    public com.example.demo.fedex.rate.stub.SignatureOptionDetail getDerivedPackageSignatureOptions(int i) {
        return this.derivedPackageSignatureOptions[i];
    }

    public void setDerivedPackageSignatureOptions(int i, com.example.demo.fedex.rate.stub.SignatureOptionDetail _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail getDerivedOriginDetail() {
        return derivedOriginDetail;
    }
     ...
     */
    public void setDerivedOriginDetail(com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedOriginDetail) {
        this.derivedOriginDetail = derivedOriginDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail getDerivedDestinationDetail() {
        return derivedDestinationDetail;
    }
     ...
     */
    public void setDerivedDestinationDetail(com.example.demo.fedex.rate.stub.CleansedAddressAndLocationDetail derivedDestinationDetail) {
        this.derivedDestinationDetail = derivedDestinationDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DayOfWeekType getDayOfWeek() {
        return dayOfWeek;
    }
     ...
     */
    public void setDayOfWeek(com.example.demo.fedex.rate.stub.DayOfWeekType dayOfWeek) {
        this.dayOfWeek = dayOfWeek;
    }
     ...
     * indicates minimum transit time for SmartPost.
     */
    public com.example.demo.fedex.rate.stub.TransitTimeType getTransitTime() {
        return transitTime;
    }
     ...
     * indicates minimum transit time for SmartPost.
     */
    public void setTransitTime(com.example.demo.fedex.rate.stub.TransitTimeType transitTime) {
        this.transitTime = transitTime;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.TransitTimeType getMaximumTransitTime() {
     ...
     */
    public void setMaximumTransitTime(com.example.demo.fedex.rate.stub.TransitTimeType maximumTransitTime) {
        this.maximumTransitTime = maximumTransitTime;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Address getBrokerAddress() {
     ...
     */
    public void setBrokerAddress(com.example.demo.fedex.rate.stub.Address brokerAddress) {
        this.brokerAddress = brokerAddress;
    }
     ...
     * at the border.
     */
    public com.example.demo.fedex.rate.stub.DayOfWeekType getBrokerCommitDayOfWeek() {
     ...
     * at the border.
     */
    public void setBrokerCommitDayOfWeek(com.example.demo.fedex.rate.stub.DayOfWeekType brokerCommitDayOfWeek) {
        this.brokerCommitDayOfWeek = brokerCommitDayOfWeek;
    }
     ...
     * by GSP (Global Service Provider)
     */
    public com.example.demo.fedex.rate.stub.DayOfWeekType getProofOfDeliveryDayOfWeek() {
     ...
     * by GSP (Global Service Provider)
     */
    public void setProofOfDeliveryDayOfWeek(com.example.demo.fedex.rate.stub.DayOfWeekType proofOfDeliveryDayOfWeek) {
        this.proofOfDeliveryDayOfWeek = proofOfDeliveryDayOfWeek;
    }
     ...
     * or a successful message such as "REQUEST COMPLETED"
     */
    public com.example.demo.fedex.rate.stub.Notification[] getCommitMessages() {
     ...
     * or a successful message such as "REQUEST COMPLETED"
     */
    public void setCommitMessages(com.example.demo.fedex.rate.stub.Notification[] commitMessages) {
        this.commitMessages = commitMessages;
    }

    public com.example.demo.fedex.rate.stub.Notification getCommitMessages(int i) {
        return this.commitMessages[i];
    }

    public void setCommitMessages(int i, com.example.demo.fedex.rate.stub.Notification _value) {
     ...
     * what level (country/service etc.).
     */
    public com.example.demo.fedex.rate.stub.DelayDetail[] getDelayDetails() {
        return delayDetails;
    }
     ...
     * what level (country/service etc.).
     */
    public void setDelayDetails(com.example.demo.fedex.rate.stub.DelayDetail[] delayDetails) {
        this.delayDetails = delayDetails;
    }

    public com.example.demo.fedex.rate.stub.DelayDetail getDelayDetails(int i) {
        return this.delayDetails[i];
    }

    public void setDelayDetails(int i, com.example.demo.fedex.rate.stub.DelayDetail _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.InternationalDocumentContentType getDocumentContent() {
        return documentContent;
    }
     ...
     */
    public void setDocumentContent(com.example.demo.fedex.rate.stub.InternationalDocumentContentType documentContent) {
        this.documentContent = documentContent;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.RequiredShippingDocumentType[] getRequiredDocuments() {
     ...
     */
    public void setRequiredDocuments(com.example.demo.fedex.rate.stub.RequiredShippingDocumentType[] requiredDocuments) {
        this.requiredDocuments = requiredDocuments;
    }

    public com.example.demo.fedex.rate.stub.RequiredShippingDocumentType getRequiredDocuments(int i) {
        return this.requiredDocuments[i];
    }

    public void setRequiredDocuments(int i, com.example.demo.fedex.rate.stub.RequiredShippingDocumentType _value) {
     ...
     * total distance between origin and destination city centers.
     */
    public com.example.demo.fedex.rate.stub.FreightCommitDetail getFreightCommitDetail() {
     ...
     * total distance between origin and destination city centers.
     */
    public void setFreightCommitDetail(com.example.demo.fedex.rate.stub.FreightCommitDetail freightCommitDetail) {
        this.freightCommitDetail = freightCommitDetail;
    }
