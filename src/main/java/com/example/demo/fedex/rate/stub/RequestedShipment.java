...
public class RequestedShipment  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DropoffType dropoffType;
     ...
     * in key-value pairs. */
    private com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail[] variationOptions;

    private com.example.demo.fedex.rate.stub.Weight totalWeight;
    ...
    private com.example.demo.fedex.rate.stub.Money totalInsuredValue;
    ...
    private com.example.demo.fedex.rate.stub.ShipmentAuthorizationDetail shipmentAuthorizationDetail;

    private com.example.demo.fedex.rate.stub.Party shipper;

    private com.example.demo.fedex.rate.stub.Party recipient;

    private String recipientLocationNumber;

    /* Physical starting address for the shipment, if different from
     * shipper's address. */
    private com.example.demo.fedex.rate.stub.ContactAndAddress origin;
    ...
    private com.example.demo.fedex.rate.stub.Party soldTo;

    private com.example.demo.fedex.rate.stub.Payment shippingChargesPayment;

    private com.example.demo.fedex.rate.stub.ShipmentSpecialServicesRequested specialServicesRequested;

    private com.example.demo.fedex.rate.stub.ExpressFreightDetail expressFreightDetail;

    /* Data applicable to shipments using FEDEX_FREIGHT_ECONOMY and
     * FEDEX_FREIGHT_PRIORITY services. */
    private com.example.demo.fedex.rate.stub.FreightShipmentDetail freightShipmentDetail;
     ...
     * shipping. */
    private com.example.demo.fedex.rate.stub.CustomsClearanceDetail customsClearanceDetail;

    /* For use in "process tag" transaction. */
    private com.example.demo.fedex.rate.stub.PickupDetail pickupDetail;

    /* Specifies the characteristics of a shipment pertaining to SmartPost
     * services. */
    private com.example.demo.fedex.rate.stub.SmartPostShipmentDetail smartPostDetail;

    /* If true, only the shipper/payor will have visibility of this
     * shipment. */
    private Boolean blockInsightVisibility;

    private com.example.demo.fedex.rate.stub.LabelSpecification labelSpecification;

    /* Contains data used to create additional (non-label) shipping
     * documents. */
    private com.example.demo.fedex.rate.stub.ShippingDocumentSpecification shippingDocumentSpecification;
    ...
    private com.example.demo.fedex.rate.stub.RateRequestType[] rateRequestTypes;
    ...
    private com.example.demo.fedex.rate.stub.EdtRequestType edtRequestType;
    ...
    private com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType[] shipmentOnlyFields;

    /* Specifies data structures that may be re-used multiple times
     * with s single shipment. */
    private com.example.demo.fedex.rate.stub.ShipmentConfigurationData configurationData;
     ...
     * in the shipment. */
    private com.example.demo.fedex.rate.stub.RequestedPackageLineItem[] requestedPackageLineItems;
    ...
    public RequestedShipment(
           ...
           com.example.demo.fedex.rate.stub.DropoffType dropoffType,
           String serviceType,
           String packagingType,
           com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail[] variationOptions,
           com.example.demo.fedex.rate.stub.Weight totalWeight,
           com.example.demo.fedex.rate.stub.Money totalInsuredValue,
           String preferredCurrency,
           com.example.demo.fedex.rate.stub.ShipmentAuthorizationDetail shipmentAuthorizationDetail,
           com.example.demo.fedex.rate.stub.Party shipper,
           com.example.demo.fedex.rate.stub.Party recipient,
           String recipientLocationNumber,
           com.example.demo.fedex.rate.stub.ContactAndAddress origin,
           com.example.demo.fedex.rate.stub.Party soldTo,
           com.example.demo.fedex.rate.stub.Payment shippingChargesPayment,
           com.example.demo.fedex.rate.stub.ShipmentSpecialServicesRequested specialServicesRequested,
           com.example.demo.fedex.rate.stub.ExpressFreightDetail expressFreightDetail,
           com.example.demo.fedex.rate.stub.FreightShipmentDetail freightShipmentDetail,
           String deliveryInstructions,
           com.example.demo.fedex.rate.stub.VariableHandlingChargeDetail variableHandlingChargeDetail,
           com.example.demo.fedex.rate.stub.CustomsClearanceDetail customsClearanceDetail,
           com.example.demo.fedex.rate.stub.PickupDetail pickupDetail,
           com.example.demo.fedex.rate.stub.SmartPostShipmentDetail smartPostDetail,
           Boolean blockInsightVisibility,
           com.example.demo.fedex.rate.stub.LabelSpecification labelSpecification,
           com.example.demo.fedex.rate.stub.ShippingDocumentSpecification shippingDocumentSpecification,
           com.example.demo.fedex.rate.stub.RateRequestType[] rateRequestTypes,
           com.example.demo.fedex.rate.stub.EdtRequestType edtRequestType,
           org.apache.axis.types.NonNegativeInteger packageCount,
           com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType[] shipmentOnlyFields,
           com.example.demo.fedex.rate.stub.ShipmentConfigurationData configurationData,
           com.example.demo.fedex.rate.stub.RequestedPackageLineItem[] requestedPackageLineItems) {
     ...
     * @return dropoffType
     */
    public com.example.demo.fedex.rate.stub.DropoffType getDropoffType() {
        return dropoffType;
    }
     ...
     * @param dropoffType
     */
    public void setDropoffType(com.example.demo.fedex.rate.stub.DropoffType dropoffType) {
        this.dropoffType = dropoffType;
    }
     ...
     * in key-value pairs.
     */
    public com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail[] getVariationOptions() {
     ...
     * in key-value pairs.
     */
    public void setVariationOptions(com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail[] variationOptions) {
        this.variationOptions = variationOptions;
    }

    public com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail getVariationOptions(int i) {
        return this.variationOptions[i];
    }

    public void setVariationOptions(int i, com.example.demo.fedex.rate.stub.ShipmentVariationOptionDetail _value) {
     ...
     * @return totalWeight
     */
    public com.example.demo.fedex.rate.stub.Weight getTotalWeight() {
        return totalWeight;
    }
     ...
     * @param totalWeight
     */
    public void setTotalWeight(com.example.demo.fedex.rate.stub.Weight totalWeight) {
        this.totalWeight = totalWeight;
    }
     ...
     * relating to the shipment.
     */
    public com.example.demo.fedex.rate.stub.Money getTotalInsuredValue() {
     ...
     * relating to the shipment.
     */
    public void setTotalInsuredValue(com.example.demo.fedex.rate.stub.Money totalInsuredValue) {
        this.totalInsuredValue = totalInsuredValue;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentAuthorizationDetail getShipmentAuthorizationDetail() {
     ...
     */
    public void setShipmentAuthorizationDetail(com.example.demo.fedex.rate.stub.ShipmentAuthorizationDetail shipmentAuthorizationDetail) {
        this.shipmentAuthorizationDetail = shipmentAuthorizationDetail;
    }
     ...
     * @return shipper
     */
    public com.example.demo.fedex.rate.stub.Party getShipper() {
        return shipper;
    }
     ...
     * @param shipper
     */
    public void setShipper(com.example.demo.fedex.rate.stub.Party shipper) {
        this.shipper = shipper;
    }
     ...
     * @return recipient
     */
    public com.example.demo.fedex.rate.stub.Party getRecipient() {
        return recipient;
    }
     ...
     * @param recipient
     */
    public void setRecipient(com.example.demo.fedex.rate.stub.Party recipient) {
        this.recipient = recipient;
    }
     ...
     * shipper's address.
     */
    public com.example.demo.fedex.rate.stub.ContactAndAddress getOrigin() {
        return origin;
    }
     ...
     * shipper's address.
     */
    public void setOrigin(com.example.demo.fedex.rate.stub.ContactAndAddress origin) {
        this.origin = origin;
    }
     ...
     * vary based on whether a sold-to party was specified on a consolidation.
     */
    public com.example.demo.fedex.rate.stub.Party getSoldTo() {
        return soldTo;
    }
     ...
     * vary based on whether a sold-to party was specified on a consolidation.
     */
    public void setSoldTo(com.example.demo.fedex.rate.stub.Party soldTo) {
        this.soldTo = soldTo;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Payment getShippingChargesPayment() {
        return shippingChargesPayment;
    }
     ...
     */
    public void setShippingChargesPayment(com.example.demo.fedex.rate.stub.Payment shippingChargesPayment) {
        this.shippingChargesPayment = shippingChargesPayment;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentSpecialServicesRequested getSpecialServicesRequested() {
        return specialServicesRequested;
    }
     ...
     */
    public void setSpecialServicesRequested(com.example.demo.fedex.rate.stub.ShipmentSpecialServicesRequested specialServicesRequested) {
        this.specialServicesRequested = specialServicesRequested;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ExpressFreightDetail getExpressFreightDetail() {
        return expressFreightDetail;
    }
     ...
     */
    public void setExpressFreightDetail(com.example.demo.fedex.rate.stub.ExpressFreightDetail expressFreightDetail) {
        this.expressFreightDetail = expressFreightDetail;
    }
     ...
     * FEDEX_FREIGHT_PRIORITY services.
     */
    public com.example.demo.fedex.rate.stub.FreightShipmentDetail getFreightShipmentDetail() {
     ...
     * FEDEX_FREIGHT_PRIORITY services.
     */
    public void setFreightShipmentDetail(com.example.demo.fedex.rate.stub.FreightShipmentDetail freightShipmentDetail) {
        this.freightShipmentDetail = freightShipmentDetail;
    }
     ...
     * shipping.
     */
    public com.example.demo.fedex.rate.stub.CustomsClearanceDetail getCustomsClearanceDetail() {
     ...
     * shipping.
     */
    public void setCustomsClearanceDetail(com.example.demo.fedex.rate.stub.CustomsClearanceDetail customsClearanceDetail) {
        this.customsClearanceDetail = customsClearanceDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.PickupDetail getPickupDetail() {
        return pickupDetail;
    }
     ...
     */
    public void setPickupDetail(com.example.demo.fedex.rate.stub.PickupDetail pickupDetail) {
        this.pickupDetail = pickupDetail;
    }
     ...
     * services.
     */
    public com.example.demo.fedex.rate.stub.SmartPostShipmentDetail getSmartPostDetail() {
     ...
     * services.
     */
    public void setSmartPostDetail(com.example.demo.fedex.rate.stub.SmartPostShipmentDetail smartPostDetail) {
        this.smartPostDetail = smartPostDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.LabelSpecification getLabelSpecification() {
        return labelSpecification;
    }
     ...
     */
    public void setLabelSpecification(com.example.demo.fedex.rate.stub.LabelSpecification labelSpecification) {
        this.labelSpecification = labelSpecification;
    }
     ...
     * documents.
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentSpecification getShippingDocumentSpecification() {
     ...
     * documents.
     */
    public void setShippingDocumentSpecification(com.example.demo.fedex.rate.stub.ShippingDocumentSpecification shippingDocumentSpecification) {
        this.shippingDocumentSpecification = shippingDocumentSpecification;
    }
     ...
     * by other data on the shipment and customer.
     */
    public com.example.demo.fedex.rate.stub.RateRequestType[] getRateRequestTypes() {
     ...
     * by other data on the shipment and customer.
     */
    public void setRateRequestTypes(com.example.demo.fedex.rate.stub.RateRequestType[] rateRequestTypes) {
        this.rateRequestTypes = rateRequestTypes;
    }

    public com.example.demo.fedex.rate.stub.RateRequestType getRateRequestTypes(int i) {
        return this.rateRequestTypes[i];
    }

    public void setRateRequestTypes(int i, com.example.demo.fedex.rate.stub.RateRequestType _value) {
     ...
     * applies with shipments moving under international services.
     */
    public com.example.demo.fedex.rate.stub.EdtRequestType getEdtRequestType() {
     ...
     * applies with shipments moving under international services.
     */
    public void setEdtRequestType(com.example.demo.fedex.rate.stub.EdtRequestType edtRequestType) {
        this.edtRequestType = edtRequestType;
    }
     ...
     * here will not be provided at the package-level.
     */
    public com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType[] getShipmentOnlyFields() {
     ...
     * here will not be provided at the package-level.
     */
    public void setShipmentOnlyFields(com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType[] shipmentOnlyFields) {
        this.shipmentOnlyFields = shipmentOnlyFields;
    }

    public com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType getShipmentOnlyFields(int i) {
        return this.shipmentOnlyFields[i];
    }

    public void setShipmentOnlyFields(int i, com.example.demo.fedex.rate.stub.ShipmentOnlyFieldsType _value) {
     ...
     * with s single shipment.
     */
    public com.example.demo.fedex.rate.stub.ShipmentConfigurationData getConfigurationData() {
     ...
     * with s single shipment.
     */
    public void setConfigurationData(com.example.demo.fedex.rate.stub.ShipmentConfigurationData configurationData) {
        this.configurationData = configurationData;
    }
     ...
     * in the shipment.
     */
    public com.example.demo.fedex.rate.stub.RequestedPackageLineItem[] getRequestedPackageLineItems() {
     ...
     * in the shipment.
     */
    public void setRequestedPackageLineItems(com.example.demo.fedex.rate.stub.RequestedPackageLineItem[] requestedPackageLineItems) {
        this.requestedPackageLineItems = requestedPackageLineItems;
    }

    public com.example.demo.fedex.rate.stub.RequestedPackageLineItem getRequestedPackageLineItems(int i) {
        return this.requestedPackageLineItems[i];
    }

    public void setRequestedPackageLineItems(int i, com.example.demo.fedex.rate.stub.RequestedPackageLineItem _value) {
