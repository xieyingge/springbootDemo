...
public class DocTabContentZone001  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.DocTabZoneSpecification[] docTabZoneSpecifications;

    public DocTabContentZone001() {
    }

    public DocTabContentZone001(
           com.example.demo.fedex.rate.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
     ...
     */
    public com.example.demo.fedex.rate.stub.DocTabZoneSpecification[] getDocTabZoneSpecifications() {
        return docTabZoneSpecifications;
    }
     ...
     */
    public void setDocTabZoneSpecifications(com.example.demo.fedex.rate.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
        this.docTabZoneSpecifications = docTabZoneSpecifications;
    }

    public com.example.demo.fedex.rate.stub.DocTabZoneSpecification getDocTabZoneSpecifications(int i) {
        return this.docTabZoneSpecifications[i];
    }

    public void setDocTabZoneSpecifications(int i, com.example.demo.fedex.rate.stub.DocTabZoneSpecification _value) {
