...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.EdtTaxDetail[] taxes;
    ...
    public EdtCommodityTax(
           ...
           com.example.demo.fedex.rate.stub.EdtTaxDetail[] taxes) {
     ...
     * @return taxes
     */
    public com.example.demo.fedex.rate.stub.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.example.demo.fedex.rate.stub.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.example.demo.fedex.rate.stub.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.example.demo.fedex.rate.stub.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
