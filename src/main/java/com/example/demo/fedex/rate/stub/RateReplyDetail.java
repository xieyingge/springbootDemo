...
public class RateReplyDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DayOfWeekType deliveryDayOfWeek;

    private java.util.Calendar deliveryTimestamp;

    private com.example.demo.fedex.rate.stub.CommitDetail[] commitDetails;
    ...
    private com.example.demo.fedex.rate.stub.SignatureOptionType signatureOption;

    private com.example.demo.fedex.rate.stub.ReturnedRateType actualRateType;

    /* Each element contains all rate data for a single rate type. */
    private com.example.demo.fedex.rate.stub.RatedShipmentDetail[] ratedShipmentDetails;
    ...
    public RateReplyDetail(
           ...
           com.example.demo.fedex.rate.stub.DayOfWeekType deliveryDayOfWeek,
           java.util.Calendar deliveryTimestamp,
           com.example.demo.fedex.rate.stub.CommitDetail[] commitDetails,
           ...
           com.example.demo.fedex.rate.stub.SignatureOptionType signatureOption,
           com.example.demo.fedex.rate.stub.ReturnedRateType actualRateType,
           com.example.demo.fedex.rate.stub.RatedShipmentDetail[] ratedShipmentDetails) {
     ...
     */
    public com.example.demo.fedex.rate.stub.DayOfWeekType getDeliveryDayOfWeek() {
        return deliveryDayOfWeek;
    }
     ...
     */
    public void setDeliveryDayOfWeek(com.example.demo.fedex.rate.stub.DayOfWeekType deliveryDayOfWeek) {
        this.deliveryDayOfWeek = deliveryDayOfWeek;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CommitDetail[] getCommitDetails() {
        return commitDetails;
    }
     ...
     * @param commitDetails
     */
    public void setCommitDetails(com.example.demo.fedex.rate.stub.CommitDetail[] commitDetails) {
        this.commitDetails = commitDetails;
    }

    public com.example.demo.fedex.rate.stub.CommitDetail getCommitDetails(int i) {
        return this.commitDetails[i];
    }

    public void setCommitDetails(int i, com.example.demo.fedex.rate.stub.CommitDetail _value) {
     ...
     * with other service features in the shipment.
     */
    public com.example.demo.fedex.rate.stub.SignatureOptionType getSignatureOption() {
     ...
     * with other service features in the shipment.
     */
    public void setSignatureOption(com.example.demo.fedex.rate.stub.SignatureOptionType signatureOption) {
        this.signatureOption = signatureOption;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ReturnedRateType getActualRateType() {
        return actualRateType;
    }
     ...
     */
    public void setActualRateType(com.example.demo.fedex.rate.stub.ReturnedRateType actualRateType) {
        this.actualRateType = actualRateType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.RatedShipmentDetail[] getRatedShipmentDetails() {
     ...
     */
    public void setRatedShipmentDetails(com.example.demo.fedex.rate.stub.RatedShipmentDetail[] ratedShipmentDetails) {
        this.ratedShipmentDetails = ratedShipmentDetails;
    }

    public com.example.demo.fedex.rate.stub.RatedShipmentDetail getRatedShipmentDetails(int i) {
        return this.ratedShipmentDetails[i];
    }

    public void setRatedShipmentDetails(int i, com.example.demo.fedex.rate.stub.RatedShipmentDetail _value) {
