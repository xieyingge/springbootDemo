...
public class ShipmentEventNotificationDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType;

    private String personalMessage;

    private com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications;

    public ShipmentEventNotificationDetail() {
    }

    public ShipmentEventNotificationDetail(
           com.example.demo.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType,
           String personalMessage,
           com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentNotificationAggregationType getAggregationType() {
        return aggregationType;
    }
     ...
     */
    public void setAggregationType(com.example.demo.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification[] getEventNotifications() {
        return eventNotifications;
    }
     ...
     */
    public void setEventNotifications(com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
        this.eventNotifications = eventNotifications;
    }

    public com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification getEventNotifications(int i) {
        return this.eventNotifications[i];
    }

    public void setEventNotifications(int i, com.example.demo.fedex.rate.stub.ShipmentEventNotificationSpecification _value) {
