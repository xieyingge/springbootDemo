...
public class SignatureOptionDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.SignatureOptionType optionType;
    ...
    public SignatureOptionDetail(
           com.example.demo.fedex.rate.stub.SignatureOptionType optionType,
     ...
     * @return optionType
     */
    public com.example.demo.fedex.rate.stub.SignatureOptionType getOptionType() {
        return optionType;
    }
     ...
     * @param optionType
     */
    public void setOptionType(com.example.demo.fedex.rate.stub.SignatureOptionType optionType) {
        this.optionType = optionType;
    }
