...
public class ServiceSubOptionDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.FreightGuaranteeType freightGuarantee;

    /* Identifies the smartPostHubId used during rate quote, if SMART_POST_HUB_ID
     * is a variable option on the rate request. */
    private String smartPostHubId;

    /* Identifies the indicia used during rate quote, if SMART_POST_ALLOWED_INDICIA
     * is a variable option on the rate request. */
    private com.example.demo.fedex.rate.stub.SmartPostIndiciaType smartPostIndicia;

    public ServiceSubOptionDetail() {
    }

    public ServiceSubOptionDetail(
           com.example.demo.fedex.rate.stub.FreightGuaranteeType freightGuarantee,
           String smartPostHubId,
           com.example.demo.fedex.rate.stub.SmartPostIndiciaType smartPostIndicia) {
     ...
     * is applied to the rate quote.
     */
    public com.example.demo.fedex.rate.stub.FreightGuaranteeType getFreightGuarantee() {
     ...
     * is applied to the rate quote.
     */
    public void setFreightGuarantee(com.example.demo.fedex.rate.stub.FreightGuaranteeType freightGuarantee) {
        this.freightGuarantee = freightGuarantee;
    }
     ...
     * is a variable option on the rate request.
     */
    public void setSmartPostHubId(String smartPostHubId) {
        this.smartPostHubId = smartPostHubId;
    }
     ...
     * is a variable option on the rate request.
     */
    public com.example.demo.fedex.rate.stub.SmartPostIndiciaType getSmartPostIndicia() {
     ...
     * is a variable option on the rate request.
     */
    public void setSmartPostIndicia(com.example.demo.fedex.rate.stub.SmartPostIndiciaType smartPostIndicia) {
        this.smartPostIndicia = smartPostIndicia;
    }
