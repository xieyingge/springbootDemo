...
public class FreightGuaranteeDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.FreightGuaranteeType type;
    ...
    public FreightGuaranteeDetail(
           com.example.demo.fedex.rate.stub.FreightGuaranteeType type,
           java.util.Date date) {
           this.type = type;
           this.date = date;
    }
     ...
     * @return type
     */
    public com.example.demo.fedex.rate.stub.FreightGuaranteeType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.example.demo.fedex.rate.stub.FreightGuaranteeType type) {
        this.type = type;
    }
