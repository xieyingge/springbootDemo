...
public class ShippingDocumentEMailRecipient  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.EMailNotificationRecipientType recipientType;
    ...
    public ShippingDocumentEMailRecipient(
           com.example.demo.fedex.rate.stub.EMailNotificationRecipientType recipientType,
           String address) {
     ...
     */
    public com.example.demo.fedex.rate.stub.EMailNotificationRecipientType getRecipientType() {
     ...
     */
    public void setRecipientType(com.example.demo.fedex.rate.stub.EMailNotificationRecipientType recipientType) {
        this.recipientType = recipientType;
    }
