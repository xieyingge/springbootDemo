...
public class ReturnEMailDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices;
    ...
    public ReturnEMailDetail(
           ...
           com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
     ...
     * controlled by this list.
     */
    public com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType[] getAllowedSpecialServices() {
     ...
     * controlled by this list.
     */
    public void setAllowedSpecialServices(com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
        this.allowedSpecialServices = allowedSpecialServices;
    }

    public com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType getAllowedSpecialServices(int i) {
        return this.allowedSpecialServices[i];
    }

    public void setAllowedSpecialServices(int i, com.example.demo.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType _value) {
