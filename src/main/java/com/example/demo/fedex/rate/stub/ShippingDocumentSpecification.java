...
public class ShippingDocumentSpecification  implements java.io.Serializable {
     ...
     * shipper. */
    private com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] shippingDocumentTypes;

    private com.example.demo.fedex.rate.stub.CertificateOfOriginDetail certificateOfOrigin;

    private com.example.demo.fedex.rate.stub.CommercialInvoiceDetail commercialInvoiceDetail;

    /* Specifies the production of each package-level custom document
     * (the same specification is used for all packages). */
    private com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customPackageDocumentDetail;

    /* Specifies the production of a shipment-level custom document. */
    private com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customShipmentDocumentDetail;

    private com.example.demo.fedex.rate.stub.ExportDeclarationDetail exportDeclarationDetail;

    private com.example.demo.fedex.rate.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail;

    private com.example.demo.fedex.rate.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail;

    /* Specifies the production of the OP-900 document for hazardous
     * materials packages. */
    private com.example.demo.fedex.rate.stub.Op900Detail op900Detail;

    /* Specifies the production of the 1421c document for dangerous
     * goods shipment. */
    private com.example.demo.fedex.rate.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail;

    /* Specifies the production of the OP-900 document for hazardous
     * materials. */
    private com.example.demo.fedex.rate.stub.FreightAddressLabelDetail freightAddressLabelDetail;

    /* Specifies the production of the return instructions document. */
    private com.example.demo.fedex.rate.stub.ReturnInstructionsDetail returnInstructionsDetail;

    public ShippingDocumentSpecification() {
    }

    public ShippingDocumentSpecification(
           com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] shippingDocumentTypes,
           com.example.demo.fedex.rate.stub.CertificateOfOriginDetail certificateOfOrigin,
           com.example.demo.fedex.rate.stub.CommercialInvoiceDetail commercialInvoiceDetail,
           com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customPackageDocumentDetail,
           com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customShipmentDocumentDetail,
           com.example.demo.fedex.rate.stub.ExportDeclarationDetail exportDeclarationDetail,
           com.example.demo.fedex.rate.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail,
           com.example.demo.fedex.rate.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail,
           com.example.demo.fedex.rate.stub.Op900Detail op900Detail,
           com.example.demo.fedex.rate.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail,
           com.example.demo.fedex.rate.stub.FreightAddressLabelDetail freightAddressLabelDetail,
           com.example.demo.fedex.rate.stub.ReturnInstructionsDetail returnInstructionsDetail) {
     ...
     * shipper.
     */
    public com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] getShippingDocumentTypes() {
     ...
     * shipper.
     */
    public void setShippingDocumentTypes(com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] shippingDocumentTypes) {
        this.shippingDocumentTypes = shippingDocumentTypes;
    }

    public com.example.demo.fedex.rate.stub.RequestedShippingDocumentType getShippingDocumentTypes(int i) {
        return this.shippingDocumentTypes[i];
    }

    public void setShippingDocumentTypes(int i, com.example.demo.fedex.rate.stub.RequestedShippingDocumentType _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CertificateOfOriginDetail getCertificateOfOrigin() {
        return certificateOfOrigin;
    }
     ...
     */
    public void setCertificateOfOrigin(com.example.demo.fedex.rate.stub.CertificateOfOriginDetail certificateOfOrigin) {
        this.certificateOfOrigin = certificateOfOrigin;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CommercialInvoiceDetail getCommercialInvoiceDetail() {
        return commercialInvoiceDetail;
    }
     ...
     */
    public void setCommercialInvoiceDetail(com.example.demo.fedex.rate.stub.CommercialInvoiceDetail commercialInvoiceDetail) {
        this.commercialInvoiceDetail = commercialInvoiceDetail;
    }
     ...
     * (the same specification is used for all packages).
     */
    public com.example.demo.fedex.rate.stub.CustomDocumentDetail[] getCustomPackageDocumentDetail() {
     ...
     * (the same specification is used for all packages).
     */
    public void setCustomPackageDocumentDetail(com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customPackageDocumentDetail) {
        this.customPackageDocumentDetail = customPackageDocumentDetail;
    }

    public com.example.demo.fedex.rate.stub.CustomDocumentDetail getCustomPackageDocumentDetail(int i) {
        return this.customPackageDocumentDetail[i];
    }

    public void setCustomPackageDocumentDetail(int i, com.example.demo.fedex.rate.stub.CustomDocumentDetail _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomDocumentDetail[] getCustomShipmentDocumentDetail() {
     ...
     */
    public void setCustomShipmentDocumentDetail(com.example.demo.fedex.rate.stub.CustomDocumentDetail[] customShipmentDocumentDetail) {
        this.customShipmentDocumentDetail = customShipmentDocumentDetail;
    }

    public com.example.demo.fedex.rate.stub.CustomDocumentDetail getCustomShipmentDocumentDetail(int i) {
        return this.customShipmentDocumentDetail[i];
    }

    public void setCustomShipmentDocumentDetail(int i, com.example.demo.fedex.rate.stub.CustomDocumentDetail _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ExportDeclarationDetail getExportDeclarationDetail() {
        return exportDeclarationDetail;
    }
     ...
     */
    public void setExportDeclarationDetail(com.example.demo.fedex.rate.stub.ExportDeclarationDetail exportDeclarationDetail) {
        this.exportDeclarationDetail = exportDeclarationDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.GeneralAgencyAgreementDetail getGeneralAgencyAgreementDetail() {
        return generalAgencyAgreementDetail;
    }
     ...
     */
    public void setGeneralAgencyAgreementDetail(com.example.demo.fedex.rate.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail) {
        this.generalAgencyAgreementDetail = generalAgencyAgreementDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.NaftaCertificateOfOriginDetail getNaftaCertificateOfOriginDetail() {
        return naftaCertificateOfOriginDetail;
    }
     ...
     */
    public void setNaftaCertificateOfOriginDetail(com.example.demo.fedex.rate.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail) {
        this.naftaCertificateOfOriginDetail = naftaCertificateOfOriginDetail;
    }
     ...
     * materials packages.
     */
    public com.example.demo.fedex.rate.stub.Op900Detail getOp900Detail() {
        return op900Detail;
    }
     ...
     * materials packages.
     */
    public void setOp900Detail(com.example.demo.fedex.rate.stub.Op900Detail op900Detail) {
        this.op900Detail = op900Detail;
    }
     ...
     * goods shipment.
     */
    public com.example.demo.fedex.rate.stub.DangerousGoodsShippersDeclarationDetail getDangerousGoodsShippersDeclarationDetail() {
     ...
     * goods shipment.
     */
    public void setDangerousGoodsShippersDeclarationDetail(com.example.demo.fedex.rate.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail) {
        this.dangerousGoodsShippersDeclarationDetail = dangerousGoodsShippersDeclarationDetail;
    }
     ...
     * materials.
     */
    public com.example.demo.fedex.rate.stub.FreightAddressLabelDetail getFreightAddressLabelDetail() {
     ...
     * materials.
     */
    public void setFreightAddressLabelDetail(com.example.demo.fedex.rate.stub.FreightAddressLabelDetail freightAddressLabelDetail) {
        this.freightAddressLabelDetail = freightAddressLabelDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ReturnInstructionsDetail getReturnInstructionsDetail() {
     ...
     */
    public void setReturnInstructionsDetail(com.example.demo.fedex.rate.stub.ReturnInstructionsDetail returnInstructionsDetail) {
        this.returnInstructionsDetail = returnInstructionsDetail;
    }
