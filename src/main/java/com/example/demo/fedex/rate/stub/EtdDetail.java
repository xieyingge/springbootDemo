...
public class EtdDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.EtdAttributeType[] attributes;
    ...
    private com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] requestedDocumentCopies;

    private com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail[] documentReferences;

    public EtdDetail() {
    }

    public EtdDetail(
           com.example.demo.fedex.rate.stub.EtdAttributeType[] attributes,
           com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] requestedDocumentCopies,
           com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail[] documentReferences) {
     ...
     * @return attributes
     */
    public com.example.demo.fedex.rate.stub.EtdAttributeType[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(com.example.demo.fedex.rate.stub.EtdAttributeType[] attributes) {
        this.attributes = attributes;
    }

    public com.example.demo.fedex.rate.stub.EtdAttributeType getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, com.example.demo.fedex.rate.stub.EtdAttributeType _value) {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] getRequestedDocumentCopies() {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public void setRequestedDocumentCopies(com.example.demo.fedex.rate.stub.RequestedShippingDocumentType[] requestedDocumentCopies) {
        this.requestedDocumentCopies = requestedDocumentCopies;
    }

    public com.example.demo.fedex.rate.stub.RequestedShippingDocumentType getRequestedDocumentCopies(int i) {
        return this.requestedDocumentCopies[i];
    }

    public void setRequestedDocumentCopies(int i, com.example.demo.fedex.rate.stub.RequestedShippingDocumentType _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail[] getDocumentReferences() {
        return documentReferences;
    }
     ...
     */
    public void setDocumentReferences(com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail[] documentReferences) {
        this.documentReferences = documentReferences;
    }

    public com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail getDocumentReferences(int i) {
        return this.documentReferences[i];
    }

    public void setDocumentReferences(int i, com.example.demo.fedex.rate.stub.UploadDocumentReferenceDetail _value) {
