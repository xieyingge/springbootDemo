...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.WebAuthenticationCredential parentCredential;

    /* Credential used to authenticate a specific software application.
     * This value is provided by FedEx after registration. */
    private com.example.demo.fedex.rate.stub.WebAuthenticationCredential userCredential;

    public WebAuthenticationDetail() {
    }

    public WebAuthenticationDetail(
           com.example.demo.fedex.rate.stub.WebAuthenticationCredential parentCredential,
           com.example.demo.fedex.rate.stub.WebAuthenticationCredential userCredential) {
     ...
     */
    public com.example.demo.fedex.rate.stub.WebAuthenticationCredential getParentCredential() {
     ...
     */
    public void setParentCredential(com.example.demo.fedex.rate.stub.WebAuthenticationCredential parentCredential) {
        this.parentCredential = parentCredential;
    }
     ...
     * This value is provided by FedEx after registration.
     */
    public com.example.demo.fedex.rate.stub.WebAuthenticationCredential getUserCredential() {
     ...
     * This value is provided by FedEx after registration.
     */
    public void setUserCredential(com.example.demo.fedex.rate.stub.WebAuthenticationCredential userCredential) {
        this.userCredential = userCredential;
    }
