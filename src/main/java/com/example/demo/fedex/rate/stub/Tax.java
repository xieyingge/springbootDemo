...
public class Tax  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.TaxType taxType;
    ...
    public Tax(
           com.example.demo.fedex.rate.stub.TaxType taxType,
           String description,
     ...
     * @return taxType
     */
    public com.example.demo.fedex.rate.stub.TaxType getTaxType() {
        return taxType;
    }
     ...
     * @param taxType
     */
    public void setTaxType(com.example.demo.fedex.rate.stub.TaxType taxType) {
        this.taxType = taxType;
    }
