...
public class PriorityAlertDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes;
    ...
    public PriorityAlertDetail(
           com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes,
           String[] content) {
     ...
     */
    public com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType[] getEnhancementTypes() {
        return enhancementTypes;
    }
     ...
     */
    public void setEnhancementTypes(com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes) {
        this.enhancementTypes = enhancementTypes;
    }

    public com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType getEnhancementTypes(int i) {
        return this.enhancementTypes[i];
    }

    public void setEnhancementTypes(int i, com.example.demo.fedex.rate.stub.PriorityAlertEnhancementType _value) {
