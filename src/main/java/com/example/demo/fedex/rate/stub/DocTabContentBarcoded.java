...
public class DocTabContentBarcoded  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.BarcodeSymbologyType symbology;

    private com.example.demo.fedex.rate.stub.DocTabZoneSpecification specification;

    public DocTabContentBarcoded() {
    }

    public DocTabContentBarcoded(
           com.example.demo.fedex.rate.stub.BarcodeSymbologyType symbology,
           com.example.demo.fedex.rate.stub.DocTabZoneSpecification specification) {
     ...
     * @return symbology
     */
    public com.example.demo.fedex.rate.stub.BarcodeSymbologyType getSymbology() {
        return symbology;
    }
     ...
     * @param symbology
     */
    public void setSymbology(com.example.demo.fedex.rate.stub.BarcodeSymbologyType symbology) {
        this.symbology = symbology;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DocTabZoneSpecification getSpecification() {
        return specification;
    }
     ...
     * @param specification
     */
    public void setSpecification(com.example.demo.fedex.rate.stub.DocTabZoneSpecification specification) {
        this.specification = specification;
    }
