...
public class DelayDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DelayLevelType level;

    /* The point where the delay is occurring (e.g. Origin, Destination,
     * Broker location) */
    private com.example.demo.fedex.rate.stub.DelayPointType point;

    /* The reason for the delay (e.g. holiday, weekend, etc.). */
    private com.example.demo.fedex.rate.stub.CommitmentDelayType type;
    ...
    public DelayDetail(
           ...
           com.example.demo.fedex.rate.stub.DelayLevelType level,
           com.example.demo.fedex.rate.stub.DelayPointType point,
           com.example.demo.fedex.rate.stub.CommitmentDelayType type,
           String description) {
           this.date = date;
     ...
     * City, LocationId, Zip, service area, special handling )
     */
    public com.example.demo.fedex.rate.stub.DelayLevelType getLevel() {
        return level;
    }
     ...
     * City, LocationId, Zip, service area, special handling )
     */
    public void setLevel(com.example.demo.fedex.rate.stub.DelayLevelType level) {
        this.level = level;
    }
     ...
     * Broker location)
     */
    public com.example.demo.fedex.rate.stub.DelayPointType getPoint() {
        return point;
    }
     ...
     * Broker location)
     */
    public void setPoint(com.example.demo.fedex.rate.stub.DelayPointType point) {
        this.point = point;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CommitmentDelayType getType() {
        return type;
    }
     ...
     */
    public void setType(com.example.demo.fedex.rate.stub.CommitmentDelayType type) {
        this.type = type;
    }
