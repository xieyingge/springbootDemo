...
public class HomeDeliveryPremiumDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.HomeDeliveryPremiumType homeDeliveryPremiumType;
    ...
    public HomeDeliveryPremiumDetail(
           com.example.demo.fedex.rate.stub.HomeDeliveryPremiumType homeDeliveryPremiumType,
           java.util.Date date,
           String phoneNumber) {
     ...
     */
    public com.example.demo.fedex.rate.stub.HomeDeliveryPremiumType getHomeDeliveryPremiumType() {
        return homeDeliveryPremiumType;
    }
     ...
     */
    public void setHomeDeliveryPremiumType(com.example.demo.fedex.rate.stub.HomeDeliveryPremiumType homeDeliveryPremiumType) {
        this.homeDeliveryPremiumType = homeDeliveryPremiumType;
    }
