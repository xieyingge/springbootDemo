...
public class CustomsOptionDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.CustomsOptionType type;
    ...
    public CustomsOptionDetail(
           com.example.demo.fedex.rate.stub.CustomsOptionType type,
           String description) {
           this.type = type;
     ...
     * @return type
     */
    public com.example.demo.fedex.rate.stub.CustomsOptionType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.example.demo.fedex.rate.stub.CustomsOptionType type) {
        this.type = type;
    }
