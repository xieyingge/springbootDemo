...
public class FreightServiceCenterDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.Distance localDistance;
    ...
    private com.example.demo.fedex.rate.stub.FreightServiceSchedulingType localServiceScheduling;

    /* Specifies days of operation if localServiceScheduling is LIMITED. */
    private com.example.demo.fedex.rate.stub.DayOfWeekType[] limitedServiceDays;
    ...
    private com.example.demo.fedex.rate.stub.ContactAndAddress contactAndAddress;

    public FreightServiceCenterDetail() {
    }

    public FreightServiceCenterDetail(
           String interlineCarrierCode,
           String interlineCarrierName,
           Integer additionalDays,
           String localService,
           com.example.demo.fedex.rate.stub.Distance localDistance,
           org.apache.axis.types.Duration localDuration,
           com.example.demo.fedex.rate.stub.FreightServiceSchedulingType localServiceScheduling,
           com.example.demo.fedex.rate.stub.DayOfWeekType[] limitedServiceDays,
           String gatewayLocationId,
           String location,
           com.example.demo.fedex.rate.stub.ContactAndAddress contactAndAddress) {
     ...
     */
    public void setInterlineCarrierCode(String interlineCarrierCode) {
        this.interlineCarrierCode = interlineCarrierCode;
    }
     ...
     */
    public void setInterlineCarrierName(String interlineCarrierName) {
        this.interlineCarrierName = interlineCarrierName;
    }
     ...
     * the supporting Freight / National Freight service center.
     */
    public com.example.demo.fedex.rate.stub.Distance getLocalDistance() {
     ...
     * the supporting Freight / National Freight service center.
     */
    public void setLocalDistance(com.example.demo.fedex.rate.stub.Distance localDistance) {
        this.localDistance = localDistance;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightServiceSchedulingType getLocalServiceScheduling() {
     ...
     */
    public void setLocalServiceScheduling(com.example.demo.fedex.rate.stub.FreightServiceSchedulingType localServiceScheduling) {
        this.localServiceScheduling = localServiceScheduling;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DayOfWeekType[] getLimitedServiceDays() {
     ...
     */
    public void setLimitedServiceDays(com.example.demo.fedex.rate.stub.DayOfWeekType[] limitedServiceDays) {
        this.limitedServiceDays = limitedServiceDays;
    }

    public com.example.demo.fedex.rate.stub.DayOfWeekType getLimitedServiceDays(int i) {
        return this.limitedServiceDays[i];
    }

    public void setLimitedServiceDays(int i, com.example.demo.fedex.rate.stub.DayOfWeekType _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ContactAndAddress getContactAndAddress() {
     ...
     */
    public void setContactAndAddress(com.example.demo.fedex.rate.stub.ContactAndAddress contactAndAddress) {
        this.contactAndAddress = contactAndAddress;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getLimitedServiceDays() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getLimitedServiceDays(), i);
                if (obj != null &&
