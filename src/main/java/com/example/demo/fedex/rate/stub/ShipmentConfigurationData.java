...
public class ShipmentConfigurationData  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations;

    public ShipmentConfigurationData() {
    }

    public ShipmentConfigurationData(
           com.example.demo.fedex.rate.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations) {
     ...
     * with identical dangerous goods commodities.
     */
    public com.example.demo.fedex.rate.stub.DangerousGoodsDetail[] getDangerousGoodsPackageConfigurations() {
     ...
     * with identical dangerous goods commodities.
     */
    public void setDangerousGoodsPackageConfigurations(com.example.demo.fedex.rate.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations) {
        this.dangerousGoodsPackageConfigurations = dangerousGoodsPackageConfigurations;
    }

    public com.example.demo.fedex.rate.stub.DangerousGoodsDetail getDangerousGoodsPackageConfigurations(int i) {
        return this.dangerousGoodsPackageConfigurations[i];
    }

    public void setDangerousGoodsPackageConfigurations(int i, com.example.demo.fedex.rate.stub.DangerousGoodsDetail _value) {
