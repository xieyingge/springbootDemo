...
public class AlcoholDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.AlcoholRecipientType recipientType;

    public AlcoholDetail() {
    }

    public AlcoholDetail(
           com.example.demo.fedex.rate.stub.AlcoholRecipientType recipientType) {
     ...
     */
    public com.example.demo.fedex.rate.stub.AlcoholRecipientType getRecipientType() {
     ...
     */
    public void setRecipientType(com.example.demo.fedex.rate.stub.AlcoholRecipientType recipientType) {
        this.recipientType = recipientType;
    }
