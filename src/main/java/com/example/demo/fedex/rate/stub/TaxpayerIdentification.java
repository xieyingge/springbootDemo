...
public class TaxpayerIdentification  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.TinType tinType;
    ...
    public TaxpayerIdentification(
           com.example.demo.fedex.rate.stub.TinType tinType,
           String number,
           String usage,
     ...
     * @return tinType
     */
    public com.example.demo.fedex.rate.stub.TinType getTinType() {
        return tinType;
    }
     ...
     * @param tinType
     */
    public void setTinType(com.example.demo.fedex.rate.stub.TinType tinType) {
        this.tinType = tinType;
    }
