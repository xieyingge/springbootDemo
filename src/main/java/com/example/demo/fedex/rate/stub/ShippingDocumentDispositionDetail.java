...
public class ShippingDocumentDispositionDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ShippingDocumentDispositionType dispositionType;

    /* Specifies how to organize all documents of this type. */
    private com.example.demo.fedex.rate.stub.ShippingDocumentGroupingType grouping;

    /* Specifies how to e-mail document images. */
    private com.example.demo.fedex.rate.stub.ShippingDocumentEMailDetail EMailDetail;

    /* Specifies how a queued document is to be printed. */
    private com.example.demo.fedex.rate.stub.ShippingDocumentPrintDetail printDetail;

    public ShippingDocumentDispositionDetail() {
    }

    public ShippingDocumentDispositionDetail(
           com.example.demo.fedex.rate.stub.ShippingDocumentDispositionType dispositionType,
           com.example.demo.fedex.rate.stub.ShippingDocumentGroupingType grouping,
           com.example.demo.fedex.rate.stub.ShippingDocumentEMailDetail EMailDetail,
           com.example.demo.fedex.rate.stub.ShippingDocumentPrintDetail printDetail) {
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentDispositionType getDispositionType() {
     ...
     */
    public void setDispositionType(com.example.demo.fedex.rate.stub.ShippingDocumentDispositionType dispositionType) {
        this.dispositionType = dispositionType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentGroupingType getGrouping() {
        return grouping;
    }
     ...
     */
    public void setGrouping(com.example.demo.fedex.rate.stub.ShippingDocumentGroupingType grouping) {
        this.grouping = grouping;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentEMailDetail getEMailDetail() {
        return EMailDetail;
    }
     ...
     */
    public void setEMailDetail(com.example.demo.fedex.rate.stub.ShippingDocumentEMailDetail EMailDetail) {
        this.EMailDetail = EMailDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentPrintDetail getPrintDetail() {
        return printDetail;
    }
     ...
     */
    public void setPrintDetail(com.example.demo.fedex.rate.stub.ShippingDocumentPrintDetail printDetail) {
        this.printDetail = printDetail;
    }
