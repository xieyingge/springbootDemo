...
public class CustomerSpecifiedLabelDetail  implements java.io.Serializable {
     ...
     * NONE type). */
    private com.example.demo.fedex.rate.stub.DocTabContent docTabContent;

    /* Controls the position of the customer specified content relative
     * to the FedEx portion. */
    private com.example.demo.fedex.rate.stub.RelativeVerticalPositionType customContentPosition;

    private com.example.demo.fedex.rate.stub.CustomLabelDetail customContent;

    private com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries;

    /* Controls which data/sections will be suppressed. */
    private com.example.demo.fedex.rate.stub.LabelMaskableDataType[] maskedData;
    ...
    private com.example.demo.fedex.rate.stub.SecondaryBarcodeType secondaryBarcode;

    private com.example.demo.fedex.rate.stub.Localization termsAndConditionsLocalization;

    private com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail[] regulatoryLabels;

    /* Controls the number of additional copies of supplemental labels. */
    private com.example.demo.fedex.rate.stub.AdditionalLabelsDetail[] additionalLabels;
    ...
    public CustomerSpecifiedLabelDetail(
           com.example.demo.fedex.rate.stub.DocTabContent docTabContent,
           com.example.demo.fedex.rate.stub.RelativeVerticalPositionType customContentPosition,
           com.example.demo.fedex.rate.stub.CustomLabelDetail customContent,
           com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries,
           com.example.demo.fedex.rate.stub.LabelMaskableDataType[] maskedData,
           com.example.demo.fedex.rate.stub.SecondaryBarcodeType secondaryBarcode,
           com.example.demo.fedex.rate.stub.Localization termsAndConditionsLocalization,
           com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail[] regulatoryLabels,
           com.example.demo.fedex.rate.stub.AdditionalLabelsDetail[] additionalLabels,
     ...
     * NONE type).
     */
    public com.example.demo.fedex.rate.stub.DocTabContent getDocTabContent() {
     ...
     * NONE type).
     */
    public void setDocTabContent(com.example.demo.fedex.rate.stub.DocTabContent docTabContent) {
        this.docTabContent = docTabContent;
    }
     ...
     * to the FedEx portion.
     */
    public com.example.demo.fedex.rate.stub.RelativeVerticalPositionType getCustomContentPosition() {
     ...
     * to the FedEx portion.
     */
    public void setCustomContentPosition(com.example.demo.fedex.rate.stub.RelativeVerticalPositionType customContentPosition) {
        this.customContentPosition = customContentPosition;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomLabelDetail getCustomContent() {
        return customContent;
    }
     ...
     * @param customContent
     */
    public void setCustomContent(com.example.demo.fedex.rate.stub.CustomLabelDetail customContent) {
        this.customContent = customContent;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry[] getConfigurableReferenceEntries() {
        return configurableReferenceEntries;
    }
     ...
     */
    public void setConfigurableReferenceEntries(com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries) {
        this.configurableReferenceEntries = configurableReferenceEntries;
    }

    public com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry getConfigurableReferenceEntries(int i) {
        return this.configurableReferenceEntries[i];
    }

    public void setConfigurableReferenceEntries(int i, com.example.demo.fedex.rate.stub.ConfigurableLabelReferenceEntry _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.LabelMaskableDataType[] getMaskedData() {
        return maskedData;
    }
     ...
     */
    public void setMaskedData(com.example.demo.fedex.rate.stub.LabelMaskableDataType[] maskedData) {
        this.maskedData = maskedData;
    }

    public com.example.demo.fedex.rate.stub.LabelMaskableDataType getMaskedData(int i) {
        return this.maskedData[i];
    }

    public void setMaskedData(int i, com.example.demo.fedex.rate.stub.LabelMaskableDataType _value) {
     ...
     * that the primary barcode produced by FedEx has the correct SCNC.
     */
    public com.example.demo.fedex.rate.stub.SecondaryBarcodeType getSecondaryBarcode() {
     ...
     * that the primary barcode produced by FedEx has the correct SCNC.
     */
    public void setSecondaryBarcode(com.example.demo.fedex.rate.stub.SecondaryBarcodeType secondaryBarcode) {
        this.secondaryBarcode = secondaryBarcode;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Localization getTermsAndConditionsLocalization() {
        return termsAndConditionsLocalization;
    }
     ...
     */
    public void setTermsAndConditionsLocalization(com.example.demo.fedex.rate.stub.Localization termsAndConditionsLocalization) {
        this.termsAndConditionsLocalization = termsAndConditionsLocalization;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail[] getRegulatoryLabels() {
        return regulatoryLabels;
    }
     ...
     */
    public void setRegulatoryLabels(com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail[] regulatoryLabels) {
        this.regulatoryLabels = regulatoryLabels;
    }

    public com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail getRegulatoryLabels(int i) {
        return this.regulatoryLabels[i];
    }

    public void setRegulatoryLabels(int i, com.example.demo.fedex.rate.stub.RegulatoryLabelContentDetail _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.AdditionalLabelsDetail[] getAdditionalLabels() {
     ...
     */
    public void setAdditionalLabels(com.example.demo.fedex.rate.stub.AdditionalLabelsDetail[] additionalLabels) {
        this.additionalLabels = additionalLabels;
    }

    public com.example.demo.fedex.rate.stub.AdditionalLabelsDetail getAdditionalLabels(int i) {
        return this.additionalLabels[i];
    }

    public void setAdditionalLabels(int i, com.example.demo.fedex.rate.stub.AdditionalLabelsDetail _value) {
