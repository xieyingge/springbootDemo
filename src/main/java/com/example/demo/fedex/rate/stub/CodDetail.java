...
public class CodDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.Money codCollectionAmount;

    /* Specifies the details of the charges are to be added to the
     * COD collect amount. */
    private com.example.demo.fedex.rate.stub.CodAddTransportationChargesDetail addTransportationChargesDetail;

    /* Identifies the type of funds FedEx should collect upon package
     * delivery */
    private com.example.demo.fedex.rate.stub.CodCollectionType collectionType;
    ...
    private com.example.demo.fedex.rate.stub.Party codRecipient;
     ...
     * payment of the COD. */
    private com.example.demo.fedex.rate.stub.ContactAndAddress financialInstitutionContactAndAddress;
    ...
    private com.example.demo.fedex.rate.stub.CodReturnReferenceIndicatorType referenceIndicator;

    /* Only used with multi-piece COD shipments sent in multiple transactions.
     * Required on last transaction only. */
    private com.example.demo.fedex.rate.stub.TrackingId returnTrackingId;

    public CodDetail() {
    }

    public CodDetail(
           com.example.demo.fedex.rate.stub.Money codCollectionAmount,
           com.example.demo.fedex.rate.stub.CodAddTransportationChargesDetail addTransportationChargesDetail,
           com.example.demo.fedex.rate.stub.CodCollectionType collectionType,
           com.example.demo.fedex.rate.stub.Party codRecipient,
           com.example.demo.fedex.rate.stub.ContactAndAddress financialInstitutionContactAndAddress,
           String remitToName,
           com.example.demo.fedex.rate.stub.CodReturnReferenceIndicatorType referenceIndicator,
           com.example.demo.fedex.rate.stub.TrackingId returnTrackingId) {
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getCodCollectionAmount() {
        return codCollectionAmount;
    }
     ...
     */
    public void setCodCollectionAmount(com.example.demo.fedex.rate.stub.Money codCollectionAmount) {
        this.codCollectionAmount = codCollectionAmount;
    }
     ...
     * COD collect amount.
     */
    public com.example.demo.fedex.rate.stub.CodAddTransportationChargesDetail getAddTransportationChargesDetail() {
     ...
     * COD collect amount.
     */
    public void setAddTransportationChargesDetail(com.example.demo.fedex.rate.stub.CodAddTransportationChargesDetail addTransportationChargesDetail) {
        this.addTransportationChargesDetail = addTransportationChargesDetail;
    }
     ...
     * delivery
     */
    public com.example.demo.fedex.rate.stub.CodCollectionType getCollectionType() {
     ...
     * delivery
     */
    public void setCollectionType(com.example.demo.fedex.rate.stub.CodCollectionType collectionType) {
        this.collectionType = collectionType;
    }
     ...
     * that prints the COD receipt.
     */
    public com.example.demo.fedex.rate.stub.Party getCodRecipient() {
        return codRecipient;
    }
     ...
     * that prints the COD receipt.
     */
    public void setCodRecipient(com.example.demo.fedex.rate.stub.Party codRecipient) {
        this.codRecipient = codRecipient;
    }
     ...
     * payment of the COD.
     */
    public com.example.demo.fedex.rate.stub.ContactAndAddress getFinancialInstitutionContactAndAddress() {
     ...
     * payment of the COD.
     */
    public void setFinancialInstitutionContactAndAddress(com.example.demo.fedex.rate.stub.ContactAndAddress financialInstitutionContactAndAddress) {
        this.financialInstitutionContactAndAddress = financialInstitutionContactAndAddress;
    }
     ...
     * the COD return shipping label.
     */
    public com.example.demo.fedex.rate.stub.CodReturnReferenceIndicatorType getReferenceIndicator() {
     ...
     * the COD return shipping label.
     */
    public void setReferenceIndicator(com.example.demo.fedex.rate.stub.CodReturnReferenceIndicatorType referenceIndicator) {
        this.referenceIndicator = referenceIndicator;
    }
     ...
     * Required on last transaction only.
     */
    public com.example.demo.fedex.rate.stub.TrackingId getReturnTrackingId() {
     ...
     * Required on last transaction only.
     */
    public void setReturnTrackingId(com.example.demo.fedex.rate.stub.TrackingId returnTrackingId) {
        this.returnTrackingId = returnTrackingId;
    }
