...
public class NaftaProducer  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.Party producer;
    ...
    public NaftaProducer(
           String id,
           com.example.demo.fedex.rate.stub.Party producer) {
           this.id = id;
     ...
     * @return producer
     */
    public com.example.demo.fedex.rate.stub.Party getProducer() {
        return producer;
    }
     ...
     * @param producer
     */
    public void setProducer(com.example.demo.fedex.rate.stub.Party producer) {
        this.producer = producer;
    }
