...
public class PackageSpecialServicesRequested  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DangerousGoodsDetail dangerousGoodsDetail;

    /* Provides details about the batteries or cells that are contained
     * within this specific package. */
    private com.example.demo.fedex.rate.stub.BatteryClassificationDetail[] batteryDetails;

    private com.example.demo.fedex.rate.stub.Weight dryIceWeight;

    private com.example.demo.fedex.rate.stub.SignatureOptionDetail signatureOptionDetail;

    private com.example.demo.fedex.rate.stub.PriorityAlertDetail priorityAlertDetail;

    private com.example.demo.fedex.rate.stub.AlcoholDetail alcoholDetail;
    ...
    public PackageSpecialServicesRequested(
           ...
           com.example.demo.fedex.rate.stub.DangerousGoodsDetail dangerousGoodsDetail,
           com.example.demo.fedex.rate.stub.BatteryClassificationDetail[] batteryDetails,
           com.example.demo.fedex.rate.stub.Weight dryIceWeight,
           com.example.demo.fedex.rate.stub.SignatureOptionDetail signatureOptionDetail,
           com.example.demo.fedex.rate.stub.PriorityAlertDetail priorityAlertDetail,
           com.example.demo.fedex.rate.stub.AlcoholDetail alcoholDetail) {
     ...
     */
    public com.example.demo.fedex.rate.stub.DangerousGoodsDetail getDangerousGoodsDetail() {
        return dangerousGoodsDetail;
    }
     ...
     */
    public void setDangerousGoodsDetail(com.example.demo.fedex.rate.stub.DangerousGoodsDetail dangerousGoodsDetail) {
        this.dangerousGoodsDetail = dangerousGoodsDetail;
    }
     ...
     * within this specific package.
     */
    public com.example.demo.fedex.rate.stub.BatteryClassificationDetail[] getBatteryDetails() {
     ...
     * within this specific package.
     */
    public void setBatteryDetails(com.example.demo.fedex.rate.stub.BatteryClassificationDetail[] batteryDetails) {
        this.batteryDetails = batteryDetails;
    }

    public com.example.demo.fedex.rate.stub.BatteryClassificationDetail getBatteryDetails(int i) {
        return this.batteryDetails[i];
    }

    public void setBatteryDetails(int i, com.example.demo.fedex.rate.stub.BatteryClassificationDetail _value) {
     ...
     * @return dryIceWeight
     */
    public com.example.demo.fedex.rate.stub.Weight getDryIceWeight() {
        return dryIceWeight;
    }
     ...
     * @param dryIceWeight
     */
    public void setDryIceWeight(com.example.demo.fedex.rate.stub.Weight dryIceWeight) {
        this.dryIceWeight = dryIceWeight;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.SignatureOptionDetail getSignatureOptionDetail() {
        return signatureOptionDetail;
    }
     ...
     */
    public void setSignatureOptionDetail(com.example.demo.fedex.rate.stub.SignatureOptionDetail signatureOptionDetail) {
        this.signatureOptionDetail = signatureOptionDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.PriorityAlertDetail getPriorityAlertDetail() {
        return priorityAlertDetail;
    }
     ...
     */
    public void setPriorityAlertDetail(com.example.demo.fedex.rate.stub.PriorityAlertDetail priorityAlertDetail) {
        this.priorityAlertDetail = priorityAlertDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.AlcoholDetail getAlcoholDetail() {
        return alcoholDetail;
    }
     ...
     * @param alcoholDetail
     */
    public void setAlcoholDetail(com.example.demo.fedex.rate.stub.AlcoholDetail alcoholDetail) {
        this.alcoholDetail = alcoholDetail;
    }
