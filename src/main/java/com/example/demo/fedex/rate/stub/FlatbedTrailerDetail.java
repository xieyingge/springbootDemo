...
public class FlatbedTrailerDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.FlatbedTrailerOption[] options;

    public FlatbedTrailerDetail() {
    }

    public FlatbedTrailerDetail(
           com.example.demo.fedex.rate.stub.FlatbedTrailerOption[] options) {
     ...
     * @return options
     */
    public com.example.demo.fedex.rate.stub.FlatbedTrailerOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.example.demo.fedex.rate.stub.FlatbedTrailerOption[] options) {
        this.options = options;
    }

    public com.example.demo.fedex.rate.stub.FlatbedTrailerOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.example.demo.fedex.rate.stub.FlatbedTrailerOption _value) {
