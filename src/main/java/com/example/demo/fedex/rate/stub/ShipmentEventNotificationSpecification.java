...
public class ShipmentEventNotificationSpecification  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.ShipmentNotificationRoleType role;

    private com.example.demo.fedex.rate.stub.NotificationEventType[] events;

    private com.example.demo.fedex.rate.stub.NotificationDetail notificationDetail;

    private com.example.demo.fedex.rate.stub.ShipmentNotificationFormatSpecification formatSpecification;

    public ShipmentEventNotificationSpecification() {
    }

    public ShipmentEventNotificationSpecification(
           com.example.demo.fedex.rate.stub.ShipmentNotificationRoleType role,
           com.example.demo.fedex.rate.stub.NotificationEventType[] events,
           com.example.demo.fedex.rate.stub.NotificationDetail notificationDetail,
           com.example.demo.fedex.rate.stub.ShipmentNotificationFormatSpecification formatSpecification) {
           this.role = role;
           this.events = events;
     ...
     * @return role
     */
    public com.example.demo.fedex.rate.stub.ShipmentNotificationRoleType getRole() {
        return role;
    }
     ...
     * @param role
     */
    public void setRole(com.example.demo.fedex.rate.stub.ShipmentNotificationRoleType role) {
        this.role = role;
    }
     ...
     * @return events
     */
    public com.example.demo.fedex.rate.stub.NotificationEventType[] getEvents() {
        return events;
    }
     ...
     * @param events
     */
    public void setEvents(com.example.demo.fedex.rate.stub.NotificationEventType[] events) {
        this.events = events;
    }

    public com.example.demo.fedex.rate.stub.NotificationEventType getEvents(int i) {
        return this.events[i];
    }

    public void setEvents(int i, com.example.demo.fedex.rate.stub.NotificationEventType _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.NotificationDetail getNotificationDetail() {
        return notificationDetail;
    }
     ...
     */
    public void setNotificationDetail(com.example.demo.fedex.rate.stub.NotificationDetail notificationDetail) {
        this.notificationDetail = notificationDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.ShipmentNotificationFormatSpecification getFormatSpecification() {
        return formatSpecification;
    }
     ...
     */
    public void setFormatSpecification(com.example.demo.fedex.rate.stub.ShipmentNotificationFormatSpecification formatSpecification) {
        this.formatSpecification = formatSpecification;
    }
