...
public class ConsolidationKey  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ConsolidationType type;
    ...
    public ConsolidationKey(
           com.example.demo.fedex.rate.stub.ConsolidationType type,
           String index,
           java.util.Date date) {
           this.type = type;
           this.index = index;
     ...
     */
    public com.example.demo.fedex.rate.stub.ConsolidationType getType() {
        return type;
    }
     ...
     */
    public void setType(com.example.demo.fedex.rate.stub.ConsolidationType type) {
        this.type = type;
    }
