...
public class CommercialInvoice  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.Money freightCharge;

    /* Any taxes or miscellaneous charges(other than Freight charges
     * or Insurance charges) that are associated with this shipment. */
    private com.example.demo.fedex.rate.stub.Money taxesOrMiscellaneousCharge;

    /* Specifies which kind of charge is being recorded in the preceding
     * field. */
    private com.example.demo.fedex.rate.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType;

    /* Any packing costs that are associated with this shipment. */
    private com.example.demo.fedex.rate.stub.Money packingCosts;

    /* Any handling costs that are associated with this shipment. */
    private com.example.demo.fedex.rate.stub.Money handlingCosts;
    ...
    private com.example.demo.fedex.rate.stub.PurposeOfShipmentType purpose;
    ...
    public CommercialInvoice(
           String[] comments,
           com.example.demo.fedex.rate.stub.Money freightCharge,
           com.example.demo.fedex.rate.stub.Money taxesOrMiscellaneousCharge,
           com.example.demo.fedex.rate.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType,
           com.example.demo.fedex.rate.stub.Money packingCosts,
           com.example.demo.fedex.rate.stub.Money handlingCosts,
           String specialInstructions,
           String declarationStatement,
           String paymentTerms,
           com.example.demo.fedex.rate.stub.PurposeOfShipmentType purpose,
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getFreightCharge() {
     ...
     */
    public void setFreightCharge(com.example.demo.fedex.rate.stub.Money freightCharge) {
        this.freightCharge = freightCharge;
    }
     ...
     * or Insurance charges) that are associated with this shipment.
     */
    public com.example.demo.fedex.rate.stub.Money getTaxesOrMiscellaneousCharge() {
     ...
     * or Insurance charges) that are associated with this shipment.
     */
    public void setTaxesOrMiscellaneousCharge(com.example.demo.fedex.rate.stub.Money taxesOrMiscellaneousCharge) {
        this.taxesOrMiscellaneousCharge = taxesOrMiscellaneousCharge;
    }
     ...
     * field.
     */
    public com.example.demo.fedex.rate.stub.TaxesOrMiscellaneousChargeType getTaxesOrMiscellaneousChargeType() {
     ...
     * field.
     */
    public void setTaxesOrMiscellaneousChargeType(com.example.demo.fedex.rate.stub.TaxesOrMiscellaneousChargeType taxesOrMiscellaneousChargeType) {
        this.taxesOrMiscellaneousChargeType = taxesOrMiscellaneousChargeType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getPackingCosts() {
        return packingCosts;
    }
     ...
     */
    public void setPackingCosts(com.example.demo.fedex.rate.stub.Money packingCosts) {
        this.packingCosts = packingCosts;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getHandlingCosts() {
     ...
     */
    public void setHandlingCosts(com.example.demo.fedex.rate.stub.Money handlingCosts) {
        this.handlingCosts = handlingCosts;
    }
     ...
     * for a Proforma Invoice.
     */
    public com.example.demo.fedex.rate.stub.PurposeOfShipmentType getPurpose() {
        return purpose;
    }
     ...
     * for a Proforma Invoice.
     */
    public void setPurpose(com.example.demo.fedex.rate.stub.PurposeOfShipmentType purpose) {
        this.purpose = purpose;
    }
