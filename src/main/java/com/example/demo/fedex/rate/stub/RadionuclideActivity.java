...
public class RadionuclideActivity  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.RadioactivityUnitOfMeasure unitOfMeasure;
    ...
    public RadionuclideActivity(
           ...
           com.example.demo.fedex.rate.stub.RadioactivityUnitOfMeasure unitOfMeasure) {
           this.value = value;
     ...
     */
    public com.example.demo.fedex.rate.stub.RadioactivityUnitOfMeasure getUnitOfMeasure() {
        return unitOfMeasure;
    }
     ...
     * @param unitOfMeasure
     */
    public void setUnitOfMeasure(com.example.demo.fedex.rate.stub.RadioactivityUnitOfMeasure unitOfMeasure) {
        this.unitOfMeasure = unitOfMeasure;
    }
