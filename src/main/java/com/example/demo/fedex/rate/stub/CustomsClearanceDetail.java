...
public class CustomsClearanceDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.BrokerDetail[] brokers;

    /* Interacts both with properties of the shipment and contractual
     * relationship with the shipper. */
    private com.example.demo.fedex.rate.stub.ClearanceBrokerageType clearanceBrokerage;

    private com.example.demo.fedex.rate.stub.CustomsOptionDetail customsOptions;

    private com.example.demo.fedex.rate.stub.Party importerOfRecord;
    ...
    private com.example.demo.fedex.rate.stub.RecipientCustomsId recipientCustomsId;

    private com.example.demo.fedex.rate.stub.Payment dutiesPayment;

    private com.example.demo.fedex.rate.stub.InternationalDocumentContentType documentContent;

    private com.example.demo.fedex.rate.stub.Money customsValue;

    /* Identifies responsibilities with respect to loss, damage, etc. */
    private com.example.demo.fedex.rate.stub.FreightOnValueType freightOnValue;

    /* Documents amount paid to third party for coverage of shipment
     * content. */
    private com.example.demo.fedex.rate.stub.Money insuranceCharges;

    private Boolean partiesToTransactionAreRelated;

    private com.example.demo.fedex.rate.stub.CommercialInvoice commercialInvoice;

    private com.example.demo.fedex.rate.stub.Commodity[] commodities;

    private com.example.demo.fedex.rate.stub.ExportDetail exportDetail;

    private com.example.demo.fedex.rate.stub.RegulatoryControlType[] regulatoryControls;

    public CustomsClearanceDetail() {
    }

    public CustomsClearanceDetail(
           com.example.demo.fedex.rate.stub.BrokerDetail[] brokers,
           com.example.demo.fedex.rate.stub.ClearanceBrokerageType clearanceBrokerage,
           com.example.demo.fedex.rate.stub.CustomsOptionDetail customsOptions,
           com.example.demo.fedex.rate.stub.Party importerOfRecord,
           com.example.demo.fedex.rate.stub.RecipientCustomsId recipientCustomsId,
           com.example.demo.fedex.rate.stub.Payment dutiesPayment,
           com.example.demo.fedex.rate.stub.InternationalDocumentContentType documentContent,
           com.example.demo.fedex.rate.stub.Money customsValue,
           com.example.demo.fedex.rate.stub.FreightOnValueType freightOnValue,
           com.example.demo.fedex.rate.stub.Money insuranceCharges,
           Boolean partiesToTransactionAreRelated,
           com.example.demo.fedex.rate.stub.CommercialInvoice commercialInvoice,
           com.example.demo.fedex.rate.stub.Commodity[] commodities,
           com.example.demo.fedex.rate.stub.ExportDetail exportDetail,
           com.example.demo.fedex.rate.stub.RegulatoryControlType[] regulatoryControls) {
     ...
     * @return brokers
     */
    public com.example.demo.fedex.rate.stub.BrokerDetail[] getBrokers() {
        return brokers;
    }
     ...
     * @param brokers
     */
    public void setBrokers(com.example.demo.fedex.rate.stub.BrokerDetail[] brokers) {
        this.brokers = brokers;
    }

    public com.example.demo.fedex.rate.stub.BrokerDetail getBrokers(int i) {
        return this.brokers[i];
    }

    public void setBrokers(int i, com.example.demo.fedex.rate.stub.BrokerDetail _value) {
     ...
     * relationship with the shipper.
     */
    public com.example.demo.fedex.rate.stub.ClearanceBrokerageType getClearanceBrokerage() {
     ...
     * relationship with the shipper.
     */
    public void setClearanceBrokerage(com.example.demo.fedex.rate.stub.ClearanceBrokerageType clearanceBrokerage) {
        this.clearanceBrokerage = clearanceBrokerage;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomsOptionDetail getCustomsOptions() {
        return customsOptions;
    }
     ...
     */
    public void setCustomsOptions(com.example.demo.fedex.rate.stub.CustomsOptionDetail customsOptions) {
        this.customsOptions = customsOptions;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Party getImporterOfRecord() {
        return importerOfRecord;
    }
     ...
     */
    public void setImporterOfRecord(com.example.demo.fedex.rate.stub.Party importerOfRecord) {
        this.importerOfRecord = importerOfRecord;
    }
     ...
     * the requirements on this information vary with destination country.
     */
    public com.example.demo.fedex.rate.stub.RecipientCustomsId getRecipientCustomsId() {
     ...
     * the requirements on this information vary with destination country.
     */
    public void setRecipientCustomsId(com.example.demo.fedex.rate.stub.RecipientCustomsId recipientCustomsId) {
        this.recipientCustomsId = recipientCustomsId;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Payment getDutiesPayment() {
        return dutiesPayment;
    }
     ...
     * @param dutiesPayment
     */
    public void setDutiesPayment(com.example.demo.fedex.rate.stub.Payment dutiesPayment) {
        this.dutiesPayment = dutiesPayment;
    }
     ...
     * @return customsValue
     */
    public com.example.demo.fedex.rate.stub.Money getCustomsValue() {
        return customsValue;
    }
     ...
     * @param customsValue
     */
    public void setCustomsValue(com.example.demo.fedex.rate.stub.Money customsValue) {
        this.customsValue = customsValue;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightOnValueType getFreightOnValue() {
     ...
     */
    public void setFreightOnValue(com.example.demo.fedex.rate.stub.FreightOnValueType freightOnValue) {
        this.freightOnValue = freightOnValue;
    }
     ...
     * content.
     */
    public com.example.demo.fedex.rate.stub.Money getInsuranceCharges() {
     ...
     * content.
     */
    public void setInsuranceCharges(com.example.demo.fedex.rate.stub.Money insuranceCharges) {
        this.insuranceCharges = insuranceCharges;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CommercialInvoice getCommercialInvoice() {
        return commercialInvoice;
    }
     ...
     */
    public void setCommercialInvoice(com.example.demo.fedex.rate.stub.CommercialInvoice commercialInvoice) {
        this.commercialInvoice = commercialInvoice;
    }
     ...
     * @return commodities
     */
    public com.example.demo.fedex.rate.stub.Commodity[] getCommodities() {
        return commodities;
    }
     ...
     * @param commodities
     */
    public void setCommodities(com.example.demo.fedex.rate.stub.Commodity[] commodities) {
        this.commodities = commodities;
    }

    public com.example.demo.fedex.rate.stub.Commodity getCommodities(int i) {
        return this.commodities[i];
    }

    public void setCommodities(int i, com.example.demo.fedex.rate.stub.Commodity _value) {
     ...
     * @return exportDetail
     */
    public com.example.demo.fedex.rate.stub.ExportDetail getExportDetail() {
        return exportDetail;
    }
     ...
     * @param exportDetail
     */
    public void setExportDetail(com.example.demo.fedex.rate.stub.ExportDetail exportDetail) {
        this.exportDetail = exportDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.RegulatoryControlType[] getRegulatoryControls() {
        return regulatoryControls;
    }
     ...
     */
    public void setRegulatoryControls(com.example.demo.fedex.rate.stub.RegulatoryControlType[] regulatoryControls) {
        this.regulatoryControls = regulatoryControls;
    }

    public com.example.demo.fedex.rate.stub.RegulatoryControlType getRegulatoryControls(int i) {
        return this.regulatoryControls[i];
    }

    public void setRegulatoryControls(int i, com.example.demo.fedex.rate.stub.RegulatoryControlType _value) {
