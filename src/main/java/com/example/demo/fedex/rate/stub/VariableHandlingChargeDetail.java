...
public class VariableHandlingChargeDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.Money fixedValue;
     ...
     * is applied. */
    private com.example.demo.fedex.rate.stub.RateElementBasisType rateElementBasis;
    ...
    public VariableHandlingChargeDetail(
           com.example.demo.fedex.rate.stub.Money fixedValue,
           java.math.BigDecimal percentValue,
           com.example.demo.fedex.rate.stub.RateElementBasisType rateElementBasis,
     ...
     * @return fixedValue
     */
    public com.example.demo.fedex.rate.stub.Money getFixedValue() {
        return fixedValue;
    }
     ...
     * @param fixedValue
     */
    public void setFixedValue(com.example.demo.fedex.rate.stub.Money fixedValue) {
        this.fixedValue = fixedValue;
    }
     ...
     * is applied.
     */
    public com.example.demo.fedex.rate.stub.RateElementBasisType getRateElementBasis() {
     ...
     * is applied.
     */
    public void setRateElementBasis(com.example.demo.fedex.rate.stub.RateElementBasisType rateElementBasis) {
        this.rateElementBasis = rateElementBasis;
    }
