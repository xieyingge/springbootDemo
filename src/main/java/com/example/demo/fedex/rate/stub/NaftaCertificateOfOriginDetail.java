...
public class NaftaCertificateOfOriginDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.ShippingDocumentFormat format;

    private com.example.demo.fedex.rate.stub.DateRange blanketPeriod;

    /* Indicates which Party (if any) from the shipment is to be used
     * as the source of importer data on the NAFTA COO form. */
    private com.example.demo.fedex.rate.stub.NaftaImporterSpecificationType importerSpecification;

    /* Contact information for "Authorized Signature" area of form. */
    private com.example.demo.fedex.rate.stub.Contact signatureContact;

    private com.example.demo.fedex.rate.stub.NaftaProducerSpecificationType producerSpecification;

    private com.example.demo.fedex.rate.stub.NaftaProducer[] producers;

    private com.example.demo.fedex.rate.stub.CustomerImageUsage[] customerImageUsages;

    public NaftaCertificateOfOriginDetail() {
    }

    public NaftaCertificateOfOriginDetail(
           com.example.demo.fedex.rate.stub.ShippingDocumentFormat format,
           com.example.demo.fedex.rate.stub.DateRange blanketPeriod,
           com.example.demo.fedex.rate.stub.NaftaImporterSpecificationType importerSpecification,
           com.example.demo.fedex.rate.stub.Contact signatureContact,
           com.example.demo.fedex.rate.stub.NaftaProducerSpecificationType producerSpecification,
           com.example.demo.fedex.rate.stub.NaftaProducer[] producers,
           com.example.demo.fedex.rate.stub.CustomerImageUsage[] customerImageUsages) {
           this.format = format;
     ...
     * @return format
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentFormat getFormat() {
        return format;
    }
     ...
     * @param format
     */
    public void setFormat(com.example.demo.fedex.rate.stub.ShippingDocumentFormat format) {
        this.format = format;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DateRange getBlanketPeriod() {
        return blanketPeriod;
    }
     ...
     * @param blanketPeriod
     */
    public void setBlanketPeriod(com.example.demo.fedex.rate.stub.DateRange blanketPeriod) {
        this.blanketPeriod = blanketPeriod;
    }
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public com.example.demo.fedex.rate.stub.NaftaImporterSpecificationType getImporterSpecification() {
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public void setImporterSpecification(com.example.demo.fedex.rate.stub.NaftaImporterSpecificationType importerSpecification) {
        this.importerSpecification = importerSpecification;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Contact getSignatureContact() {
     ...
     */
    public void setSignatureContact(com.example.demo.fedex.rate.stub.Contact signatureContact) {
        this.signatureContact = signatureContact;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.NaftaProducerSpecificationType getProducerSpecification() {
        return producerSpecification;
    }
     ...
     */
    public void setProducerSpecification(com.example.demo.fedex.rate.stub.NaftaProducerSpecificationType producerSpecification) {
        this.producerSpecification = producerSpecification;
    }
     ...
     * @return producers
     */
    public com.example.demo.fedex.rate.stub.NaftaProducer[] getProducers() {
        return producers;
    }
     ...
     * @param producers
     */
    public void setProducers(com.example.demo.fedex.rate.stub.NaftaProducer[] producers) {
        this.producers = producers;
    }

    public com.example.demo.fedex.rate.stub.NaftaProducer getProducers(int i) {
        return this.producers[i];
    }

    public void setProducers(int i, com.example.demo.fedex.rate.stub.NaftaProducer _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomerImageUsage[] getCustomerImageUsages() {
        return customerImageUsages;
    }
     ...
     */
    public void setCustomerImageUsages(com.example.demo.fedex.rate.stub.CustomerImageUsage[] customerImageUsages) {
        this.customerImageUsages = customerImageUsages;
    }

    public com.example.demo.fedex.rate.stub.CustomerImageUsage getCustomerImageUsages(int i) {
        return this.customerImageUsages[i];
    }

    public void setCustomerImageUsages(int i, com.example.demo.fedex.rate.stub.CustomerImageUsage _value) {
