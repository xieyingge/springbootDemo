...
public class PackageRateDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.Weight billingWeight;

    /* The dimensional weight of this package (if greater than actual). */
    private com.example.demo.fedex.rate.stub.Weight dimWeight;

    /* The oversize weight of this package (if the package is oversize). */
    private com.example.demo.fedex.rate.stub.Weight oversizeWeight;

    /* The transportation charge only (prior to any discounts applied)
     * for this package. */
    private com.example.demo.fedex.rate.stub.Money baseCharge;
    ...
    private com.example.demo.fedex.rate.stub.Money netFreight;
     ...
     * totalTaxes). */
    private com.example.demo.fedex.rate.stub.Money netFedExCharge;
    ...
    private com.example.demo.fedex.rate.stub.Money netCharge;
    ...
    public PackageRateDetail(
           ...
           com.example.demo.fedex.rate.stub.Weight billingWeight,
           com.example.demo.fedex.rate.stub.Weight dimWeight,
           com.example.demo.fedex.rate.stub.Weight oversizeWeight,
           com.example.demo.fedex.rate.stub.Money baseCharge,
           com.example.demo.fedex.rate.stub.Money totalFreightDiscounts,
           com.example.demo.fedex.rate.stub.Money netFreight,
           com.example.demo.fedex.rate.stub.Money totalSurcharges,
           com.example.demo.fedex.rate.stub.Money netFedExCharge,
           com.example.demo.fedex.rate.stub.Money totalTaxes,
           com.example.demo.fedex.rate.stub.Money netCharge,
     ...
     */
    public com.example.demo.fedex.rate.stub.Weight getBillingWeight() {
        return billingWeight;
    }
     ...
     * @param billingWeight
     */
    public void setBillingWeight(com.example.demo.fedex.rate.stub.Weight billingWeight) {
        this.billingWeight = billingWeight;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Weight getDimWeight() {
        return dimWeight;
    }
     ...
     */
    public void setDimWeight(com.example.demo.fedex.rate.stub.Weight dimWeight) {
        this.dimWeight = dimWeight;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Weight getOversizeWeight() {
     ...
     */
    public void setOversizeWeight(com.example.demo.fedex.rate.stub.Weight oversizeWeight) {
        this.oversizeWeight = oversizeWeight;
    }
     ...
     * for this package.
     */
    public com.example.demo.fedex.rate.stub.Money getBaseCharge() {
        return baseCharge;
    }
     ...
     * for this package.
     */
    public void setBaseCharge(com.example.demo.fedex.rate.stub.Money baseCharge) {
        this.baseCharge = baseCharge;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getNetFreight() {
        return netFreight;
    }
     ...
     */
    public void setNetFreight(com.example.demo.fedex.rate.stub.Money netFreight) {
        this.netFreight = netFreight;
    }
     ...
     * totalTaxes).
     */
    public com.example.demo.fedex.rate.stub.Money getNetFedExCharge() {
     ...
     * totalTaxes).
     */
    public void setNetFedExCharge(com.example.demo.fedex.rate.stub.Money netFedExCharge) {
        this.netFedExCharge = netFedExCharge;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getNetCharge() {
        return netCharge;
    }
     ...
     */
    public void setNetCharge(com.example.demo.fedex.rate.stub.Money netCharge) {
        this.netCharge = netCharge;
    }
