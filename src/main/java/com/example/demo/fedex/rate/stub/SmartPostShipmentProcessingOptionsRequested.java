...
public class SmartPostShipmentProcessingOptionsRequested  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType[] options;

    public SmartPostShipmentProcessingOptionsRequested() {
    }

    public SmartPostShipmentProcessingOptionsRequested(
           com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionType _value) {
