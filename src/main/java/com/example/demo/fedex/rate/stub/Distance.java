...
public class Distance  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.DistanceUnits units;
    ...
    public Distance(
           ...
           com.example.demo.fedex.rate.stub.DistanceUnits units) {
           this.value = value;
           this.units = units;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DistanceUnits getUnits() {
        return units;
    }
     ...
     */
    public void setUnits(com.example.demo.fedex.rate.stub.DistanceUnits units) {
        this.units = units;
    }
