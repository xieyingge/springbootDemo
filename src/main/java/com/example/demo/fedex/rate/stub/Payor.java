...
public class Payor  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.Party responsibleParty;

    public Payor() {
    }

    public Payor(
           com.example.demo.fedex.rate.stub.Party responsibleParty) {
     ...
     */
    public com.example.demo.fedex.rate.stub.Party getResponsibleParty() {
        return responsibleParty;
    }
     ...
     */
    public void setResponsibleParty(com.example.demo.fedex.rate.stub.Party responsibleParty) {
        this.responsibleParty = responsibleParty;
    }
