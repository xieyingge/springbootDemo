...
public class AncillaryFeeAndTax  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.AncillaryFeeAndTaxType type;
    ...
    public AncillaryFeeAndTax(
           com.example.demo.fedex.rate.stub.AncillaryFeeAndTaxType type,
           String description,
     ...
     * @return type
     */
    public com.example.demo.fedex.rate.stub.AncillaryFeeAndTaxType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.example.demo.fedex.rate.stub.AncillaryFeeAndTaxType type) {
        this.type = type;
    }
