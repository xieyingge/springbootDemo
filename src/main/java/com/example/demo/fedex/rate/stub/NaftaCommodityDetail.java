...
public class NaftaCommodityDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.NaftaPreferenceCriterionCode preferenceCriterion;

    /* Defined by NAFTA regulations. */
    private com.example.demo.fedex.rate.stub.NaftaProducerDeterminationCode producerDetermination;
    ...
    private com.example.demo.fedex.rate.stub.NaftaNetCostMethodCode netCostMethod;

    /* Date range over which RVC net cost was calculated. */
    private com.example.demo.fedex.rate.stub.DateRange netCostDateRange;

    public NaftaCommodityDetail() {
    }

    public NaftaCommodityDetail(
           com.example.demo.fedex.rate.stub.NaftaPreferenceCriterionCode preferenceCriterion,
           com.example.demo.fedex.rate.stub.NaftaProducerDeterminationCode producerDetermination,
           String producerId,
           com.example.demo.fedex.rate.stub.NaftaNetCostMethodCode netCostMethod,
           com.example.demo.fedex.rate.stub.DateRange netCostDateRange) {
     ...
     */
    public com.example.demo.fedex.rate.stub.NaftaPreferenceCriterionCode getPreferenceCriterion() {
     ...
     */
    public void setPreferenceCriterion(com.example.demo.fedex.rate.stub.NaftaPreferenceCriterionCode preferenceCriterion) {
        this.preferenceCriterion = preferenceCriterion;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.NaftaProducerDeterminationCode getProducerDetermination() {
     ...
     */
    public void setProducerDetermination(com.example.demo.fedex.rate.stub.NaftaProducerDeterminationCode producerDetermination) {
        this.producerDetermination = producerDetermination;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.NaftaNetCostMethodCode getNetCostMethod() {
        return netCostMethod;
    }
     ...
     * @param netCostMethod
     */
    public void setNetCostMethod(com.example.demo.fedex.rate.stub.NaftaNetCostMethodCode netCostMethod) {
        this.netCostMethod = netCostMethod;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.DateRange getNetCostDateRange() {
     ...
     */
    public void setNetCostDateRange(com.example.demo.fedex.rate.stub.DateRange netCostDateRange) {
        this.netCostDateRange = netCostDateRange;
    }
