...
public class FreightShipmentDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ContactAndAddress fedExFreightBillingContactAndAddress;

    /* Used in connection with "Send Bill To" (SBT) identification
     * of customer's account used for billing. */
    private com.example.demo.fedex.rate.stub.Party alternateBilling;

    /* Indicates the role of the party submitting the transaction. */
    private com.example.demo.fedex.rate.stub.FreightShipmentRoleType role;

    /* Designates the terms of the "collect" payment for a Freight
     * Shipment. */
    private com.example.demo.fedex.rate.stub.FreightCollectTermsType collectTermsType;

    /* Identifies the declared value for the shipment */
    private com.example.demo.fedex.rate.stub.Money declaredValuePerUnit;

    /* Identifies the declared value units corresponding to the above
     * defined declared value */
    private String declaredValueUnits;

    private com.example.demo.fedex.rate.stub.LiabilityCoverageDetail liabilityCoverageDetail;
    ...
    private com.example.demo.fedex.rate.stub.Weight palletWeight;

    /* Overall shipment dimensions. */
    private com.example.demo.fedex.rate.stub.Dimensions shipmentDimensions;
    ...
    private com.example.demo.fedex.rate.stub.FreightSpecialServicePayment[] specialServicePayments;

    private String hazardousMaterialsOfferor;

    /* Details of the commodities in the shipment. */
    private com.example.demo.fedex.rate.stub.FreightShipmentLineItem[] lineItems;
    ...
    public FreightShipmentDetail(
           ...
           com.example.demo.fedex.rate.stub.ContactAndAddress fedExFreightBillingContactAndAddress,
           com.example.demo.fedex.rate.stub.Party alternateBilling,
           com.example.demo.fedex.rate.stub.FreightShipmentRoleType role,
           com.example.demo.fedex.rate.stub.FreightCollectTermsType collectTermsType,
           com.example.demo.fedex.rate.stub.Money declaredValuePerUnit,
           String declaredValueUnits,
           com.example.demo.fedex.rate.stub.LiabilityCoverageDetail liabilityCoverageDetail,
           String[] coupons,
           org.apache.axis.types.NonNegativeInteger totalHandlingUnits,
           java.math.BigDecimal clientDiscountPercent,
           com.example.demo.fedex.rate.stub.Weight palletWeight,
           com.example.demo.fedex.rate.stub.Dimensions shipmentDimensions,
           String comment,
           com.example.demo.fedex.rate.stub.FreightSpecialServicePayment[] specialServicePayments,
           String hazardousMaterialsOfferor,
           com.example.demo.fedex.rate.stub.FreightShipmentLineItem[] lineItems) {
     ...
     * identifying third party payment on the bill of lading.
     */
    public com.example.demo.fedex.rate.stub.ContactAndAddress getFedExFreightBillingContactAndAddress() {
     ...
     * identifying third party payment on the bill of lading.
     */
    public void setFedExFreightBillingContactAndAddress(com.example.demo.fedex.rate.stub.ContactAndAddress fedExFreightBillingContactAndAddress) {
        this.fedExFreightBillingContactAndAddress = fedExFreightBillingContactAndAddress;
    }
     ...
     * of customer's account used for billing.
     */
    public com.example.demo.fedex.rate.stub.Party getAlternateBilling() {
     ...
     * of customer's account used for billing.
     */
    public void setAlternateBilling(com.example.demo.fedex.rate.stub.Party alternateBilling) {
        this.alternateBilling = alternateBilling;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightShipmentRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.example.demo.fedex.rate.stub.FreightShipmentRoleType role) {
        this.role = role;
    }
     ...
     * Shipment.
     */
    public com.example.demo.fedex.rate.stub.FreightCollectTermsType getCollectTermsType() {
     ...
     * Shipment.
     */
    public void setCollectTermsType(com.example.demo.fedex.rate.stub.FreightCollectTermsType collectTermsType) {
        this.collectTermsType = collectTermsType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Money getDeclaredValuePerUnit() {
     ...
     */
    public void setDeclaredValuePerUnit(com.example.demo.fedex.rate.stub.Money declaredValuePerUnit) {
        this.declaredValuePerUnit = declaredValuePerUnit;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.LiabilityCoverageDetail getLiabilityCoverageDetail() {
        return liabilityCoverageDetail;
    }
     ...
     */
    public void setLiabilityCoverageDetail(com.example.demo.fedex.rate.stub.LiabilityCoverageDetail liabilityCoverageDetail) {
        this.liabilityCoverageDetail = liabilityCoverageDetail;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Weight getPalletWeight() {
        return palletWeight;
    }
     ...
     */
    public void setPalletWeight(com.example.demo.fedex.rate.stub.Weight palletWeight) {
        this.palletWeight = palletWeight;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Dimensions getShipmentDimensions() {
     ...
     */
    public void setShipmentDimensions(com.example.demo.fedex.rate.stub.Dimensions shipmentDimensions) {
        this.shipmentDimensions = shipmentDimensions;
    }
     ...
     * which support split billing.
     */
    public com.example.demo.fedex.rate.stub.FreightSpecialServicePayment[] getSpecialServicePayments() {
     ...
     * which support split billing.
     */
    public void setSpecialServicePayments(com.example.demo.fedex.rate.stub.FreightSpecialServicePayment[] specialServicePayments) {
        this.specialServicePayments = specialServicePayments;
    }

    public com.example.demo.fedex.rate.stub.FreightSpecialServicePayment getSpecialServicePayments(int i) {
        return this.specialServicePayments[i];
    }

    public void setSpecialServicePayments(int i, com.example.demo.fedex.rate.stub.FreightSpecialServicePayment _value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightShipmentLineItem[] getLineItems() {
        return lineItems;
    }
     ...
     */
    public void setLineItems(com.example.demo.fedex.rate.stub.FreightShipmentLineItem[] lineItems) {
        this.lineItems = lineItems;
    }

    public com.example.demo.fedex.rate.stub.FreightShipmentLineItem getLineItems(int i) {
        return this.lineItems[i];
    }

    public void setLineItems(int i, com.example.demo.fedex.rate.stub.FreightShipmentLineItem _value) {
