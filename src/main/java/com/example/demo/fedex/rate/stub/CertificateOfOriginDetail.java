...
public class CertificateOfOriginDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ShippingDocumentFormat documentFormat;
    ...
    public CertificateOfOriginDetail(
           com.example.demo.fedex.rate.stub.ShippingDocumentFormat documentFormat,
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentFormat getDocumentFormat() {
     ...
     */
    public void setDocumentFormat(com.example.demo.fedex.rate.stub.ShippingDocumentFormat documentFormat) {
        this.documentFormat = documentFormat;
    }
