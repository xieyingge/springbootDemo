...
public class ClientDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ExpressRegionCode region;
    ...
    public ClientDetail(
           ...
           String meterNumber,
           String integratorId,
           com.example.demo.fedex.rate.stub.ExpressRegionCode region,
     ...
     */
    public com.example.demo.fedex.rate.stub.ExpressRegionCode getRegion() {
        return region;
    }
     ...
     */
    public void setRegion(com.example.demo.fedex.rate.stub.ExpressRegionCode region) {
        this.region = region;
    }
