...
public class NotificationDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.NotificationType notificationType;

    /* Specifies the email notification details. */
    private com.example.demo.fedex.rate.stub.EMailDetail emailDetail;
    ...
    public NotificationDetail(
           com.example.demo.fedex.rate.stub.NotificationType notificationType,
           com.example.demo.fedex.rate.stub.EMailDetail emailDetail,
     ...
     */
    public com.example.demo.fedex.rate.stub.NotificationType getNotificationType() {
     ...
     */
    public void setNotificationType(com.example.demo.fedex.rate.stub.NotificationType notificationType) {
        this.notificationType = notificationType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.EMailDetail getEmailDetail() {
        return emailDetail;
    }
     ...
     */
    public void setEmailDetail(com.example.demo.fedex.rate.stub.EMailDetail emailDetail) {
        this.emailDetail = emailDetail;
    }
