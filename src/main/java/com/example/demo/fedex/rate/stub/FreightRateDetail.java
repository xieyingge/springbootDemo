...
public class FreightRateDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.FreightRateQuoteType quoteType;

    /* Specifies how total base charge is determined. */
    private com.example.demo.fedex.rate.stub.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.example.demo.fedex.rate.stub.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.example.demo.fedex.rate.stub.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           String quoteNumber,
           com.example.demo.fedex.rate.stub.FreightRateQuoteType quoteType,
           com.example.demo.fedex.rate.stub.FreightBaseChargeCalculationType baseChargeCalculation,
           com.example.demo.fedex.rate.stub.FreightBaseCharge[] baseCharges,
           com.example.demo.fedex.rate.stub.FreightRateNotation[] notations) {
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightRateQuoteType getQuoteType() {
        return quoteType;
    }
     ...
     */
    public void setQuoteType(com.example.demo.fedex.rate.stub.FreightRateQuoteType quoteType) {
        this.quoteType = quoteType;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     */
    public void setBaseChargeCalculation(com.example.demo.fedex.rate.stub.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.example.demo.fedex.rate.stub.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.example.demo.fedex.rate.stub.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.example.demo.fedex.rate.stub.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.example.demo.fedex.rate.stub.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.example.demo.fedex.rate.stub.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.example.demo.fedex.rate.stub.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.example.demo.fedex.rate.stub.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.example.demo.fedex.rate.stub.FreightRateNotation _value) {
