...
public class CustomerReference  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.CustomerReferenceType customerReferenceType;
    ...
    public CustomerReference(
           com.example.demo.fedex.rate.stub.CustomerReferenceType customerReferenceType,
           String value) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomerReferenceType getCustomerReferenceType() {
        return customerReferenceType;
    }
     ...
     */
    public void setCustomerReferenceType(com.example.demo.fedex.rate.stub.CustomerReferenceType customerReferenceType) {
        this.customerReferenceType = customerReferenceType;
    }
