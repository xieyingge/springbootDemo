...
public class ShippingDocumentEMailDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient[] EMailRecipients;

    /* Identifies the convention by which documents are to be grouped
     * as e-mail attachments. */
    private com.example.demo.fedex.rate.stub.ShippingDocumentEMailGroupingType grouping;
    ...
    public ShippingDocumentEMailDetail(
           com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient[] EMailRecipients,
           com.example.demo.fedex.rate.stub.ShippingDocumentEMailGroupingType grouping,
     ...
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient[] getEMailRecipients() {
     ...
     */
    public void setEMailRecipients(com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient[] EMailRecipients) {
        this.EMailRecipients = EMailRecipients;
    }

    public com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient getEMailRecipients(int i) {
        return this.EMailRecipients[i];
    }

    public void setEMailRecipients(int i, com.example.demo.fedex.rate.stub.ShippingDocumentEMailRecipient _value) {
     ...
     * as e-mail attachments.
     */
    public com.example.demo.fedex.rate.stub.ShippingDocumentEMailGroupingType getGrouping() {
        return grouping;
    }
     ...
     * as e-mail attachments.
     */
    public void setGrouping(com.example.demo.fedex.rate.stub.ShippingDocumentEMailGroupingType grouping) {
        this.grouping = grouping;
    }
