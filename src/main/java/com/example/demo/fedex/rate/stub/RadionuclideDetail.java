...
public class RadionuclideDetail  implements java.io.Serializable {
    ...
    private com.example.demo.fedex.rate.stub.RadionuclideActivity activity;
    ...
    private com.example.demo.fedex.rate.stub.PhysicalFormType physicalForm;
    ...
    public RadionuclideDetail(
           String radionuclide,
           com.example.demo.fedex.rate.stub.RadionuclideActivity activity,
           Boolean exceptedPackagingIsReportableQuantity,
           com.example.demo.fedex.rate.stub.PhysicalFormType physicalForm,
           String chemicalForm) {
     ...
     * @return activity
     */
    public com.example.demo.fedex.rate.stub.RadionuclideActivity getActivity() {
        return activity;
    }
     ...
     * @param activity
     */
    public void setActivity(com.example.demo.fedex.rate.stub.RadionuclideActivity activity) {
        this.activity = activity;
    }
     ...
     * @return physicalForm
     */
    public com.example.demo.fedex.rate.stub.PhysicalFormType getPhysicalForm() {
        return physicalForm;
    }
     ...
     * @param physicalForm
     */
    public void setPhysicalForm(com.example.demo.fedex.rate.stub.PhysicalFormType physicalForm) {
        this.physicalForm = physicalForm;
    }
