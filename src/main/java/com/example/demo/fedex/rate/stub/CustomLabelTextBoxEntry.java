...
public class CustomLabelTextBoxEntry  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.CustomLabelPosition topLeftCorner;

    private com.example.demo.fedex.rate.stub.CustomLabelPosition bottomRightCorner;
    ...
    private com.example.demo.fedex.rate.stub.RotationType rotation;

    public CustomLabelTextBoxEntry() {
    }

    public CustomLabelTextBoxEntry(
           com.example.demo.fedex.rate.stub.CustomLabelPosition topLeftCorner,
           com.example.demo.fedex.rate.stub.CustomLabelPosition bottomRightCorner,
           ...
           com.example.demo.fedex.rate.stub.RotationType rotation) {
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomLabelPosition getTopLeftCorner() {
        return topLeftCorner;
    }
     ...
     * @param topLeftCorner
     */
    public void setTopLeftCorner(com.example.demo.fedex.rate.stub.CustomLabelPosition topLeftCorner) {
        this.topLeftCorner = topLeftCorner;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.CustomLabelPosition getBottomRightCorner() {
        return bottomRightCorner;
    }
     ...
     */
    public void setBottomRightCorner(com.example.demo.fedex.rate.stub.CustomLabelPosition bottomRightCorner) {
        this.bottomRightCorner = bottomRightCorner;
    }
     ...
     * @return rotation
     */
    public com.example.demo.fedex.rate.stub.RotationType getRotation() {
        return rotation;
    }
     ...
     * @param rotation
     */
    public void setRotation(com.example.demo.fedex.rate.stub.RotationType rotation) {
        this.rotation = rotation;
    }
