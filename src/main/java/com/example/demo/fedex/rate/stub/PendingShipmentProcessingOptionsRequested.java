...
public class PendingShipmentProcessingOptionsRequested  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType[] options;

    public PendingShipmentProcessingOptionsRequested() {
    }

    public PendingShipmentProcessingOptionsRequested(
           com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType[] options) {
     ...
     * @return options
     */
    public com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionType _value) {
