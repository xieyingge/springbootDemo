...
public class SmartPostShipmentDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionsRequested processingOptionsRequested;

    private com.example.demo.fedex.rate.stub.SmartPostIndiciaType indicia;

    private com.example.demo.fedex.rate.stub.SmartPostAncillaryEndorsementType ancillaryEndorsement;
    ...
    public SmartPostShipmentDetail(
           com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionsRequested processingOptionsRequested,
           com.example.demo.fedex.rate.stub.SmartPostIndiciaType indicia,
           com.example.demo.fedex.rate.stub.SmartPostAncillaryEndorsementType ancillaryEndorsement,
           String hubId,
     ...
     */
    public com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionsRequested getProcessingOptionsRequested() {
        return processingOptionsRequested;
    }
     ...
     */
    public void setProcessingOptionsRequested(com.example.demo.fedex.rate.stub.SmartPostShipmentProcessingOptionsRequested processingOptionsRequested) {
        this.processingOptionsRequested = processingOptionsRequested;
    }
     ...
     * @return indicia
     */
    public com.example.demo.fedex.rate.stub.SmartPostIndiciaType getIndicia() {
        return indicia;
    }
     ...
     * @param indicia
     */
    public void setIndicia(com.example.demo.fedex.rate.stub.SmartPostIndiciaType indicia) {
        this.indicia = indicia;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.SmartPostAncillaryEndorsementType getAncillaryEndorsement() {
        return ancillaryEndorsement;
    }
     ...
     */
    public void setAncillaryEndorsement(com.example.demo.fedex.rate.stub.SmartPostAncillaryEndorsementType ancillaryEndorsement) {
        this.ancillaryEndorsement = ancillaryEndorsement;
    }
