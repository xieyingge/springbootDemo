...
public class ShipmentLegRateDetail  implements java.io.Serializable {
    ...
    /* Origin for this leg. */
    private com.example.demo.fedex.rate.stub.Address legOrigin;

    /* Specifies the location id the origin of shipment leg. */
    private String legOriginLocationId;

    /* Destination for this leg. */
    private com.example.demo.fedex.rate.stub.Address legDestination;
    ...
    public ShipmentLegRateDetail(
           ...
           com.example.demo.fedex.rate.stub.Address legOrigin,
           String legOriginLocationId,
           com.example.demo.fedex.rate.stub.Address legDestination,
     ...
     */
    public com.example.demo.fedex.rate.stub.Address getLegOrigin() {
        return legOrigin;
    }
     ...
     */
    public void setLegOrigin(com.example.demo.fedex.rate.stub.Address legOrigin) {
        this.legOrigin = legOrigin;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.Address getLegDestination() {
     ...
     */
    public void setLegDestination(com.example.demo.fedex.rate.stub.Address legDestination) {
        this.legDestination = legDestination;
    }
