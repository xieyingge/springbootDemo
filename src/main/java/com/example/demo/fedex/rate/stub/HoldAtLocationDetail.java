...
public class HoldAtLocationDetail  implements java.io.Serializable {
     ...
     * to be held. */
    private com.example.demo.fedex.rate.stub.ContactAndAddress locationContactAndAddress;

    /* Type of facility at which package/shipment is to be held. */
    private com.example.demo.fedex.rate.stub.FedExLocationType locationType;
    ...
    public HoldAtLocationDetail(
           String phoneNumber,
           com.example.demo.fedex.rate.stub.ContactAndAddress locationContactAndAddress,
           com.example.demo.fedex.rate.stub.FedExLocationType locationType,
           String locationId,
     ...
     * to be held.
     */
    public com.example.demo.fedex.rate.stub.ContactAndAddress getLocationContactAndAddress() {
     ...
     * to be held.
     */
    public void setLocationContactAndAddress(com.example.demo.fedex.rate.stub.ContactAndAddress locationContactAndAddress) {
        this.locationContactAndAddress = locationContactAndAddress;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.FedExLocationType getLocationType() {
        return locationType;
    }
     ...
     */
    public void setLocationType(com.example.demo.fedex.rate.stub.FedExLocationType locationType) {
        this.locationType = locationType;
    }
