...
public class PendingShipmentDetail  implements java.io.Serializable {
    private com.example.demo.fedex.rate.stub.PendingShipmentType type;

    /* Date after which the pending shipment will no longer be available
     * for completion. */
    private java.util.Date expirationDate;

    private com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionsRequested processingOptions;

    /* These are documents that are recommended to be included with
     * the shipment. */
    private com.example.demo.fedex.rate.stub.RecommendedDocumentSpecification recommendedDocumentSpecification;

    public PendingShipmentDetail() {
    }

    public PendingShipmentDetail(
           com.example.demo.fedex.rate.stub.PendingShipmentType type,
           java.util.Date expirationDate,
           com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionsRequested processingOptions,
           com.example.demo.fedex.rate.stub.RecommendedDocumentSpecification recommendedDocumentSpecification) {
           this.type = type;
     ...
     * @return type
     */
    public com.example.demo.fedex.rate.stub.PendingShipmentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.example.demo.fedex.rate.stub.PendingShipmentType type) {
        this.type = type;
    }
     ...
     */
    public com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionsRequested getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.example.demo.fedex.rate.stub.PendingShipmentProcessingOptionsRequested processingOptions) {
        this.processingOptions = processingOptions;
    }
     ...
     * the shipment.
     */
    public com.example.demo.fedex.rate.stub.RecommendedDocumentSpecification getRecommendedDocumentSpecification() {
     ...
     * the shipment.
     */
    public void setRecommendedDocumentSpecification(com.example.demo.fedex.rate.stub.RecommendedDocumentSpecification recommendedDocumentSpecification) {
        this.recommendedDocumentSpecification = recommendedDocumentSpecification;
    }
