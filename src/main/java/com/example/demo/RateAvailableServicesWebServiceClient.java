 ...
 * <p>
 * com.example.demo.fedex.rate.stub is generated via WSDL2Java, like this:<br>
 * <pre>
 * java org.apache.axis.wsdl.WSDL2Java -w -p com.example.demo.fedex.rate.stub http://www.fedex.com/...../RateService?wsdl
 * </pre>
 * <p>
...
public class RateAvailableServicesWebServiceClient {
    ...
    private static final Map<String, Integer> FEDEX_SERVICE_TYPE = new HashMap<>();

    static {
        FEDEX_SERVICE_TYPE.put("FIRST_OVERNIGHT", 1);
        FEDEX_SERVICE_TYPE.put("PRIORITY_OVERNIGHT", 2);
        FEDEX_SERVICE_TYPE.put("STANDARD_OVERNIGHT", 3);
        FEDEX_SERVICE_TYPE.put("FEDEX_2_DAY_AM", 4);
        FEDEX_SERVICE_TYPE.put("FEDEX_2_DAY", 5);
        FEDEX_SERVICE_TYPE.put("FEDEX_EXPRESS_SAVER", 6);
        FEDEX_SERVICE_TYPE.put("FEDEX_GROUND", 7);
    }
     ...
     * @param huowushu
     */
    private static BigDecimal getByParams(String serviceType, String packagingType, Party shipper, Party recipient, RequestedPackageLineItem... huowushu) {
        ...
        try {
            ...
            if (isResponseOk(reply.getHighestSeverity())) {
                ...
                ShippingCostArea sc = new ShippingCostArea();

                RateReplyDetail rrd = rrds[0];
//                sc.setShippingMethod(FEDEX_SERVICE_TYPE.get(rrd.getServiceType()));
    ...
    public static void processShippingCostWweightRange(final BigDecimal destination, final BigDecimal increment, BigDecimal startWeight, String serviceType) {
        ...
        for (; ; ) {
            BigDecimal shippingCost = getByParams(serviceType, "YOUR_PACKAGING", from(), to(), addLineItem(weight));
